...
export interface IEverclearFeeAdapterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "newIntent(uint32[],bytes32,address,bytes32,uint256,uint24,uint48,bytes,(uint256,uint256,bytes))",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "newIntent(uint32[],address,address,address,uint256,uint24,uint48,bytes,(uint256,uint256,bytes))",
    values: [
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<string>,
      PromiseOrValue<string>,
...
export interface IEverclearFeeAdapter extends BaseContract {
  ...
  functions: {
    "newIntent(uint32[],bytes32,address,bytes32,uint256,uint24,uint48,bytes,(uint256,uint256,bytes))"(
      ...
      _feeParams: IEverclearFeeAdapter.FeeParamsStruct,
  ...
  callStatic: {
    "newIntent(uint32[],bytes32,address,bytes32,uint256,uint24,uint48,bytes,(uint256,uint256,bytes))"(
      ...
      [string, IEverclearFeeAdapter.IntentStructOutput] & {
        _intentId: string;
