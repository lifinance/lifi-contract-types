...
export declare namespace LIFIIntentFacet {
  export type LIFIIntentDataStruct = {
  ...
  export type LIFIIntentDataStructOutput = [
    string,
    BigNumber,
    string,
    BigNumber,
...
export interface LIFIIntentFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "LIFI_INTENT_COMPACT_SETTLER",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaLIFIIntent",
    values: [ILiFi.BridgeDataStruct, LIFIIntentFacet.LIFIIntentDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaLIFIIntent",
    values: [
...
export interface LIFIIntentFacet extends BaseContract {
  ...
  functions: {
    ...
    startBridgeTokensViaLIFIIntent(
      ...
      _lifiIntentData: LIFIIntentFacet.LIFIIntentDataStruct,
