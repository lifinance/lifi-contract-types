...
export type RefundAddressRegisteredEvent = TypedEvent<
  [string],
  RefundAddressRegisteredEventObject
>;

export type RefundAddressRegisteredEventFilter =
  TypedEventFilter<RefundAddressRegisteredEvent>;
...
export interface PioneerFacet extends BaseContract {
  ...
  filters: {
    ...
    "RefundAddressRegistered(address)"(
      refundTo?: null
    ): RefundAddressRegisteredEventFilter;
    RefundAddressRegistered(
      refundTo?: null
    ): RefundAddressRegisteredEventFilter;
  };
