...
export declare namespace SquidFacet {
  ...
  export type SquidDataStructOutput = [
    number,
    string,
    string,
...
export interface SquidFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "squidRouter",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaSquid",
    values: [ILiFi.BridgeDataStruct, SquidFacet.SquidDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaSquid",
    values: [
...
export interface SquidFacet extends BaseContract {
  ...
  functions: {
    ...
    startBridgeTokensViaSquid(
      ...
      _squidData: SquidFacet.SquidDataStruct,
