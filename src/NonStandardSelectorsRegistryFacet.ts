...
export interface NonStandardSelectorsRegistryFacetInterface
  ...
  encodeFunctionData(
    functionFragment: "batchSetNonStandardSelectors",
    values: [PromiseOrValue<BytesLike>[], PromiseOrValue<boolean>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "isNonStandardSelector",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "setNonStandardSelector",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<boolean>]
  ): string;
...
export interface NonStandardSelectorsRegistryFacet extends BaseContract {
  ...
  functions: {
    batchSetNonStandardSelectors(
      ...
      _isNonStandardSelectors: PromiseOrValue<boolean>[],
    ...
    setNonStandardSelector(
      _selector: PromiseOrValue<BytesLike>,
      _isNonStandardSelector: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
