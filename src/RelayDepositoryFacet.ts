...
export type RelayDepositoryDepositEventFilter =
  TypedEventFilter<RelayDepositoryDepositEvent>;
...
export interface RelayDepositoryFacet extends BaseContract {
  ...
  filters: {
    ...
    "RelayDepositoryDeposit(bytes32,address)"(
      orderId?: PromiseOrValue<BytesLike> | null,
      depository?: PromiseOrValue<string> | null
    ): RelayDepositoryDepositEventFilter;
    RelayDepositoryDeposit(
      orderId?: PromiseOrValue<BytesLike> | null,
      depository?: PromiseOrValue<string> | null
    ): RelayDepositoryDepositEventFilter;
  };
