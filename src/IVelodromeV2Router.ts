...
export interface IVelodromeV2Router extends BaseContract {
  ...
  functions: {
    ...
    generateZapInParams(
      ...
      amountInA: PromiseOrValue<BigNumberish>,
      amountInB: PromiseOrValue<BigNumberish>,
      routesA: IVelodromeV2Router.RouteStruct[],
      routesB: IVelodromeV2Router.RouteStruct[],
    ...
    zapIn(
      ...
      amountInA: PromiseOrValue<BigNumberish>,
      amountInB: PromiseOrValue<BigNumberish>,
      zapInPool: IVelodromeV2Router.ZapStruct,
      routesA: IVelodromeV2Router.RouteStruct[],
      routesB: IVelodromeV2Router.RouteStruct[],
      to: PromiseOrValue<string>,
    ...
    zapOut(
      ...
      liquidity: PromiseOrValue<BigNumberish>,
      zapOutPool: IVelodromeV2Router.ZapStruct,
      routesA: IVelodromeV2Router.RouteStruct[],
      routesB: IVelodromeV2Router.RouteStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
