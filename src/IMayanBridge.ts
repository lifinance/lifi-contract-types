...
export declare namespace IMayanBridge {
  export type RelayerFeesStruct = {
    swapFee: PromiseOrValue<BigNumberish>;
    redeemFee: PromiseOrValue<BigNumberish>;
    refundFee: PromiseOrValue<BigNumberish>;
  };

  export type RelayerFeesStructOutput = [BigNumber, BigNumber, BigNumber] & {
    swapFee: BigNumber;
    redeemFee: BigNumber;
    refundFee: BigNumber;
  };

  export type RecepientStruct = {
  ...
  export type RecepientStructOutput = [
    string,
    number,
    string,
    string,
...
export interface IMayanBridgeInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "swap" | "wrapAndSwapETH"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "wrapAndSwapETH",
    values: [
      IMayanBridge.RelayerFeesStruct,
      IMayanBridge.RecepientStruct,
      PromiseOrValue<BytesLike>,
...
export interface IMayanBridge extends BaseContract {
  ...
  functions: {
    swap(
      relayerFees: IMayanBridge.RelayerFeesStruct,
      recipient: IMayanBridge.RecepientStruct,
      tokenOutAddr: PromiseOrValue<BytesLike>,
      tokenOutChainId: PromiseOrValue<BigNumberish>,
      criteria: IMayanBridge.CriteriaStruct,
