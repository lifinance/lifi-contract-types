...
export interface GenericSwapFacetV3Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "swapTokensGenericV3FromERC20ToERC20",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "swapTokensGenericV3FromERC20ToNative",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "swapTokensGenericV3FromNativeToERC20",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
