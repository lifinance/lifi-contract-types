...
export declare namespace CCIPFacet {
  export type CCIPDataStruct = { exampleParam: PromiseOrValue<string> };

  export type CCIPDataStructOutput = [string] & { exampleParam: string };
}
...
export type CCIPInitializedEvent = TypedEvent<[], CCIPInitializedEventObject>;
