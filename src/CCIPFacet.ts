...
export declare namespace CCIPFacet {
  export type ChainSelectorStruct = {
    chainId: PromiseOrValue<BigNumberish>;
    selector: PromiseOrValue<BigNumberish>;
  };

  export type ChainSelectorStructOutput = [BigNumber, BigNumber] & {
    chainId: BigNumber;
    selector: BigNumber;
  };

  export type CCIPDataStruct = {
    callData: PromiseOrValue<BytesLike>;
    extraArgs: PromiseOrValue<BytesLike>;
    receiver: PromiseOrValue<string>;
  };

  export type CCIPDataStructOutput = [string, string, string] & {
    callData: string;
    extraArgs: string;
    receiver: string;
  };
...
export interface CCIPFacetInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "encodeDestinationArgs"
      | "initCCIP"
      | "quoteCCIPFee"
      | "routerClient"
      | "setCCIPChainSelector"
      | "startBridgeTokensViaCCIP"
      | "swapAndStartBridgeTokensViaCCIP"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "encodeDestinationArgs",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "initCCIP",
    values: [CCIPFacet.ChainSelectorStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "quoteCCIPFee",
    values: [ILiFi.BridgeDataStruct, CCIPFacet.CCIPDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "routerClient",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "setCCIPChainSelector",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaCCIP",
    values: [ILiFi.BridgeDataStruct, CCIPFacet.CCIPDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaCCIP",
    values: [
...
export type CCIPChainSelectorUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber],
  CCIPChainSelectorUpdatedEventObject
>;

export type CCIPChainSelectorUpdatedEventFilter =
  TypedEventFilter<CCIPChainSelectorUpdatedEvent>;

export interface CCIPInitializedEventObject {
  chainSelectors: CCIPFacet.ChainSelectorStructOutput[];
}
export type CCIPInitializedEvent = TypedEvent<
  [CCIPFacet.ChainSelectorStructOutput[]],
  CCIPInitializedEventObject
>;

export type CCIPInitializedEventFilter = TypedEventFilter<CCIPInitializedEvent>;
...
export interface CCIPFacet extends BaseContract {
  ...
  functions: {
    encodeDestinationArgs(
      ...
      strictSequencing: PromiseOrValue<boolean>,
      overrides?: CallOverrides
    ): Promise<[string]>;

    initCCIP(
      chainSelectors: CCIPFacet.ChainSelectorStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    quoteCCIPFee(
      _bridgeData: ILiFi.BridgeDataStruct,
      _ccipData: CCIPFacet.CCIPDataStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    setCCIPChainSelector(
      ...
      _selector: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "CCIPChainSelectorUpdated(uint256,uint64)"(
      chainId?: PromiseOrValue<BigNumberish> | null,
      selector?: null
    ): CCIPChainSelectorUpdatedEventFilter;
    CCIPChainSelectorUpdated(
      chainId?: PromiseOrValue<BigNumberish> | null,
      selector?: null
    ): CCIPChainSelectorUpdatedEventFilter;

    "CCIPInitialized(tuple[])"(
      chainSelectors?: null
    ): CCIPInitializedEventFilter;
