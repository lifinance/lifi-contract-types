...
export type CCIPRouterSetEvent = TypedEvent<[string], CCIPRouterSetEventObject>;

export type CCIPRouterSetEventFilter = TypedEventFilter<CCIPRouterSetEvent>;
...
export interface CCIPMsgReceiver extends BaseContract {
  ...
  filters: {
    "CCIPRouterSet(address)"(
      router?: PromiseOrValue<string> | null
    ): CCIPRouterSetEventFilter;
    CCIPRouterSet(
      router?: PromiseOrValue<string> | null
    ): CCIPRouterSetEventFilter;
