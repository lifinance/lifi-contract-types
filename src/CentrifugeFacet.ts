...
export declare namespace CentrifugeFacet {
  export type CentrifugeDataStruct = { receiver: PromiseOrValue<BytesLike> };

  export type CentrifugeDataStructOutput = [string] & { receiver: string };
}
...
export interface CentrifugeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaCentrifuge",
    values: [ILiFi.BridgeDataStruct, CentrifugeFacet.CentrifugeDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaCentrifuge",
    values: [
...
export interface CentrifugeFacet extends BaseContract {
  ...
  functions: {
    startBridgeTokensViaCentrifuge(
      ...
      _centrifugeData: CentrifugeFacet.CentrifugeDataStruct,
