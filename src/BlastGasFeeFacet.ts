...
export interface BlastGasFeeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "GAS_FEE_RECIPIENT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "claimGasFees",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "configureGasMode",
    values?: undefined
  ): string;
...
export type GasModeConfiguredEventFilter =
  TypedEventFilter<GasModeConfiguredEvent>;
...
export interface BlastGasFeeFacet extends BaseContract {
  ...
  filters: {
    "GasFeesClaimed(address,uint256)"(
      recipient?: PromiseOrValue<string> | null,
      amount?: null
    ): GasFeesClaimedEventFilter;
    GasFeesClaimed(
      recipient?: PromiseOrValue<string> | null,
      amount?: null
    ): GasFeesClaimedEventFilter;
