...
export declare namespace UnitFacet {
  ...
  export type UnitDataStructOutput = [string, string] & {
...
export interface UnitFacet extends BaseContract {
  ...
  filters: {
    ...
    "UnitInitialized(bytes,bytes,bytes)"(
      unitNodePublicKey?: null,
      h1NodePublicKey?: null,
      fieldNodePublicKey?: null
    ): UnitInitializedEventFilter;
    UnitInitialized(
      unitNodePublicKey?: null,
      h1NodePublicKey?: null,
      fieldNodePublicKey?: null
