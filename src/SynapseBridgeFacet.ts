...
export interface SynapseBridgeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaSynapseBridge",
    values: [ILiFi.BridgeDataStruct, SynapseBridgeFacet.SynapseDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaSynapseBridge",
    values: [
...
export interface SynapseBridgeFacet extends BaseContract {
  ...
  functions: {
    startBridgeTokensViaSynapseBridge(
      ...
      _synapseData: SynapseBridgeFacet.SynapseDataStruct,
