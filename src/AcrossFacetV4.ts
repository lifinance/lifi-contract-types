...
export interface AcrossFacetV4Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaAcrossV4",
    values: [ILiFi.BridgeDataStruct, AcrossFacetV4.AcrossV4DataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaAcrossV4",
    values: [
...
export interface AcrossFacetV4 extends BaseContract {
  ...
  functions: {
    ...
    startBridgeTokensViaAcrossV4(
      ...
      _acrossData: AcrossFacetV4.AcrossV4DataStruct,
