...
export interface WhitelistRecoveryFacetInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "clearContractSelectorsArray"
      | "clearWhitelistArrays"
      | "fullWhitelistStorageReset()"
      | "fullWhitelistStorageReset(address[],bytes4[][])"
      | "fullWhitelistStorageResetBatch"
      | "resetMigratedFlag"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "clearContractSelectorsArray",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "clearWhitelistArrays",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "fullWhitelistStorageReset()",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "fullWhitelistStorageReset(address[],bytes4[][])",
    values: [PromiseOrValue<string>[], PromiseOrValue<BytesLike>[][]]
  ): string;
  encodeFunctionData(
    functionFragment: "fullWhitelistStorageResetBatch",
    values: [PromiseOrValue<string>[], PromiseOrValue<BytesLike>[][]]
  ): string;
  encodeFunctionData(
    functionFragment: "resetMigratedFlag",
    values?: undefined
  ): string;
...
export type MigratedFlagResetEventFilter =
  TypedEventFilter<MigratedFlagResetEvent>;
...
export type WhitelistArraysClearedEventFilter =
  TypedEventFilter<WhitelistArraysClearedEvent>;
...
export type WhitelistStorageClearedEventFilter =
  TypedEventFilter<WhitelistStorageClearedEvent>;
...
export interface WhitelistRecoveryFacet extends BaseContract {
  ...
  functions: {
    ...
    "fullWhitelistStorageReset(address[],bytes4[][])"(
      _additionalContracts: PromiseOrValue<string>[],
      _additionalSelectors: PromiseOrValue<BytesLike>[][],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "MigratedFlagReset(address)"(
      caller?: PromiseOrValue<string> | null
    ): MigratedFlagResetEventFilter;
    MigratedFlagReset(
      caller?: PromiseOrValue<string> | null
    ): MigratedFlagResetEventFilter;

    "WhitelistArraysCleared(address)"(
      caller?: PromiseOrValue<string> | null
    ): WhitelistArraysClearedEventFilter;
    WhitelistArraysCleared(
      caller?: PromiseOrValue<string> | null
    ): WhitelistArraysClearedEventFilter;

    "WhitelistStorageCleared(address)"(
      caller?: PromiseOrValue<string> | null
    ): WhitelistStorageClearedEventFilter;
    WhitelistStorageCleared(
      caller?: PromiseOrValue<string> | null
    ): WhitelistStorageClearedEventFilter;
  };
