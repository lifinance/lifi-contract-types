...
export declare namespace BiconomyFacet {
  export type BiconomyDataStruct = {
    token: string;
    amount: BigNumberish;
    recipient: string;
  ...
  export type BiconomyDataStructOutput = [
    string,
    BigNumber,
    string,
    BigNumber
...
export interface BiconomyFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "changeBiconomyRouter",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "initBiconomy",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaBiconomy",
    values: [ILiFi.LiFiDataStruct, BiconomyFacet.BiconomyDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaBiconomy",
    values: [
...
export interface BiconomyFacet extends BaseContract {
  ...
  functions: {
    ...
    initBiconomy(
      _biconomyRouter: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    startBridgeTokensViaBiconomy(
      _lifiData: ILiFi.LiFiDataStruct,
      _biconomyData: BiconomyFacet.BiconomyDataStruct,
