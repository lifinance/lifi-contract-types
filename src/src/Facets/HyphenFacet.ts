...
export declare namespace HyphenFacet {
  ...
  export type HyphenDataStructOutput = [
    string,
    BigNumber,
    string,
    BigNumber
...
export interface HyphenFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaHyphen",
    values: [ILiFi.LiFiDataStruct, HyphenFacet.HyphenDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaHyphen",
    values: [
...
export type HyphenInitializedEvent = TypedEvent<
  [string],
  HyphenInitializedEventObject
>;

export type HyphenInitializedEventFilter =
  TypedEventFilter<HyphenInitializedEvent>;
...
export interface HyphenFacet extends BaseContract {
  ...
  functions: {
    initHyphen(
      _hyphenRouter: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    startBridgeTokensViaHyphen(
      _lifiData: ILiFi.LiFiDataStruct,
      _hyphenData: HyphenFacet.HyphenDataStruct,
  ...
  filters: {
    "HyphenInitialized(address)"(
      hyphenRouter?: null
    ): HyphenInitializedEventFilter;
