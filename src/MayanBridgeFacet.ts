...
export declare namespace MayanBridgeFacet {
  export type MayanBridgeDataStruct = { exampleParam: PromiseOrValue<string> };

  export type MayanBridgeDataStructOutput = [string] & { exampleParam: string };
}
...
export type MayanBridgeInitializedEvent = TypedEvent<
  [],
  MayanBridgeInitializedEventObject
>;

export type MayanBridgeInitializedEventFilter =
  TypedEventFilter<MayanBridgeInitializedEvent>;
...
export interface MayanBridgeFacet extends BaseContract {
  ...
  functions: {
    ...
    initMayanBridge(
      _exampleAllowedTokens: PromiseOrValue<string>[],
