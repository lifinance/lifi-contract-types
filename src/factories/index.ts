...
export * as ioifSol from "./IOIF.sol";
export * as iStargateSol from "./IStargate.sol";
export * as lifiIntentLibrariesSol from "./LIFIIntentLibraries.sol";
...
export { ITheCompact__factory } from "./ITheCompact__factory";
...
export { LIFIIntentFacet__factory } from "./LIFIIntentFacet__factory";
