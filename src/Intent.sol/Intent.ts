...
export interface Intent extends BaseContract {
  ...
  functions: {
    config(
      ...
      [string, string, string, string, string, BigNumber, BigNumber, number] & {
        intentId: string;
        salt: string;
        receiver: string;
        factory: string;
  ...
  filters: {
    "IntentExecuted(bytes32,address,address,uint256)"(
      intentId?: PromiseOrValue<BytesLike> | null,
      receiver?: null,
      tokenOut?: null,
      amountOut?: null
    ): IntentExecutedEventFilter;
    IntentExecuted(
      intentId?: PromiseOrValue<BytesLike> | null,
      receiver?: null,
      tokenOut?: null,
