...
export interface IM0OrderBookInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "isDestinationSupported" | "openOrder"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "isDestinationSupported",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "openOrder",
    values: [IM0OrderBook.OrderParamsStruct]
  ): string;
...
export interface IM0OrderBook extends BaseContract {
  ...
  functions: {
    ...
    openOrder(
      orderParams: IM0OrderBook.OrderParamsStruct,
