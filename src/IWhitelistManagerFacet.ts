...
export interface IWhitelistManagerFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "batchSetFunctionApprovalBySelector",
    values: [PromiseOrValue<BytesLike>[], PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "getApprovedFunctionSelectors",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFunctionApprovalBySelector",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<boolean>]
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "FunctionSelectorApprovalChanged"
  ): EventFragment;
}
...
export type FunctionSelectorApprovalChangedEventFilter =
  TypedEventFilter<FunctionSelectorApprovalChangedEvent>;
...
export interface IWhitelistManagerFacet extends BaseContract {
  ...
  filters: {
    ...
    "FunctionSelectorApprovalChanged(bytes4,bool)"(
      functionSelector?: PromiseOrValue<BytesLike> | null,
      approved?: PromiseOrValue<boolean> | null
    ): FunctionSelectorApprovalChangedEventFilter;
    FunctionSelectorApprovalChanged(
      functionSelector?: PromiseOrValue<BytesLike> | null,
      approved?: PromiseOrValue<boolean> | null
    ): FunctionSelectorApprovalChangedEventFilter;
  };
