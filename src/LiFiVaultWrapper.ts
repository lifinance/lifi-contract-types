...
export interface LiFiVaultWrapperInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "integratorFeeAssets",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "integratorFeeReceivers",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "integratorFeeShares",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "integratorShareBps",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "lastMgmtAccrual",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lifiFeeAssets",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lifiFeeShares",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "perfHighWaterMarkPps",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAccessGate",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setIntegratorFeeReceivers",
    values: [FeeReceiverStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "shareDecimalsOffset",
    values?: undefined
  ): string;
...
export interface LiFiVaultWrapper extends BaseContract {
  ...
  functions: {
    ...
    integratorFeeReceivers(
      ...
      overrides?: CallOverrides
    ): Promise<[string, number] & { wallet: string; bps: number }>;
    ...
    setFeeRate(
      _feeType: PromiseOrValue<BigNumberish>,
      _newRateBps: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
