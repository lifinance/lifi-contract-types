...
export interface AcrossFacetPackedV3Interface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [AcrossFacetPackedV3.PackedParametersStruct, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "encode_startBridgeTokensViaAcrossV3NativePacked",
    values: [AcrossFacetPackedV3.PackedParametersStruct]
  ): string;
  encodeFunctionData(
...
export interface AcrossFacetPackedV3 extends BaseContract {
  ...
  functions: {
    ...
    encode_startBridgeTokensViaAcrossV3ERC20Packed(
      _parameters: AcrossFacetPackedV3.PackedParametersStruct,
      sendingAssetId: string,
