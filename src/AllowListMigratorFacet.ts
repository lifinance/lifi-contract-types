...
export interface AllowListMigratorFacetInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "isMigrated" | "migrate"
  ): FunctionFragment;
...
export type AllowListConfigMigratedEvent = TypedEvent<
  [string[], string[]],
  AllowListConfigMigratedEventObject
>;

export type AllowListConfigMigratedEventFilter =
  TypedEventFilter<AllowListConfigMigratedEvent>;
...
export interface AllowListMigratorFacet extends BaseContract {
  ...
  filters: {
    "AllowListConfigMigrated(address[],bytes4[])"(
      contracts?: null,
      selectors?: null
    ): AllowListConfigMigratedEventFilter;
    AllowListConfigMigrated(
      contracts?: null,
      selectors?: null
    ): AllowListConfigMigratedEventFilter;
  };
