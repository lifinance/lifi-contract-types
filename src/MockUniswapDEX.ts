...
export interface MockUniswapDEXInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "inputAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "mockSwapWillRevertWithReason",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "mockSwapWithPresetInputAndOutput",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "setSwapOutput",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
...
export interface MockUniswapDEX extends BaseContract {
  ...
  functions: {
    ...
    mockSwapWithPresetInputAndOutput(
      amountInIfNotPreset: PromiseOrValue<BigNumberish>,
      amountOutIfNotPreset: PromiseOrValue<BigNumberish>,
