...
export interface DeployScript extends BaseContract {
  ...
  functions: {
    ...
    run(
      _deployerAddress: PromiseOrValue<string>,
      _create3FactoryAddress: PromiseOrValue<string>,
      _network: PromiseOrValue<string>,
      _saltPrefix: PromiseOrValue<string>,
      _isProduction: PromiseOrValue<boolean>,
  ...
  callStatic: {
    ...
    run(
      ...
      [string, string] & { deployed: string; constructorArgs: string }
    >;
  };
