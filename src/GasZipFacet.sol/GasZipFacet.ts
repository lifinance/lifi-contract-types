...
export declare namespace GasZipFacet {
  ...
  export type GasZipDataStructOutput = [
    LibSwap.SwapDataStructOutput,
    BigNumber
  ] & { gasZipSwapData: LibSwap.SwapDataStructOutput; amountOutMin: BigNumber };
}
...
export interface GasZipFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaGasZip",
    values: [ILiFi.BridgeDataStruct, GasZipFacet.GasZipDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaGasZip",
    values: [
...
export interface GasZipFacet extends BaseContract {
  ...
  functions: {
    depositToGasZipERC20(
      ...
      _destinationChains: PromiseOrValue<BigNumberish>,
    ...
    depositToGasZipNative(
      _amountToZip: PromiseOrValue<BigNumberish>,
      _destinationChains: PromiseOrValue<BigNumberish>,
      _recipient: PromiseOrValue<string>,
    ...
    startBridgeTokensViaGasZip(
      ...
      _gasZipData: GasZipFacet.GasZipDataStruct,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
