...
export declare namespace IGasZip {
  ...
  export type GasZipDataStructOutput = [BigNumber] & {
...
export interface GasZipPeripheryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IGasZip.GasZipDataStruct, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type DepositedToGasZipEvent = TypedEvent<
  [BigNumber],
  DepositedToGasZipEventObject
>;

export type DepositedToGasZipEventFilter =
  TypedEventFilter<DepositedToGasZipEvent>;
