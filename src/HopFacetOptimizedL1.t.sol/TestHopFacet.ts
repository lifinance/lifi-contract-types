...
export interface TestHopFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [ILiFi.BridgeDataStruct, HopFacetOptimized.HopDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaHopL1Native",
    values: [ILiFi.BridgeDataStruct, HopFacetOptimized.HopDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaHopL2ERC20",
    values: [ILiFi.BridgeDataStruct, HopFacetOptimized.HopDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaHopL2Native",
    values: [ILiFi.BridgeDataStruct, HopFacetOptimized.HopDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaHopL1ERC20",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaHopL1Native",
    values: [
      ILiFi.BridgeDataStruct,
      LibSwap.SwapDataStruct[],
      HopFacetOptimized.HopDataStruct
  ...
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaHopL2ERC20",
    values: [
      ILiFi.BridgeDataStruct,
      LibSwap.SwapDataStruct[],
      HopFacetOptimized.HopDataStruct
  ...
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaHopL2Native",
    values: [
      ILiFi.BridgeDataStruct,
      LibSwap.SwapDataStruct[],
      HopFacetOptimized.HopDataStruct
