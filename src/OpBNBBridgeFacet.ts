...
export interface OpBNBBridgeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initOpBNB",
    values: [OpBNBBridgeFacet.ConfigStruct[], PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "registerOpBNBBridge",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaOpBNBBridge",
    values: [ILiFi.BridgeDataStruct, OpBNBBridgeFacet.OpBNBDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaOpBNBBridge",
    values: [
...
export interface OpBNBBridgeFacet extends BaseContract {
  ...
  functions: {
    initOpBNB(
      configs: OpBNBBridgeFacet.ConfigStruct[],
    ...
    startBridgeTokensViaOpBNBBridge(
      ...
      _opBNBData: OpBNBBridgeFacet.OpBNBDataStruct,
