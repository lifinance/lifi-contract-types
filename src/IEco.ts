...
export declare namespace IEco {
  ...
  export type RouteStructOutput = [string, BigNumber, string] & {
    source: string;
  ...
  ] & { route: IEco.RouteStructOutput; reward: IEco.RewardStructOutput };
}
...
export interface IEcoInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "fund" | "publish" | "publishAndFund"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [IEco.IntentStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "publishAndFund",
    values: [IEco.IntentStruct, PromiseOrValue<boolean>]
  ): string;
