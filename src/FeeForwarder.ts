...
export interface FeeForwarderInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "forwardERC20Fees",
    values: [PromiseOrValue<string>, FeeForwarder.FeeDistributionStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "forwardNativeFees",
    values: [FeeForwarder.FeeDistributionStruct[]]
  ): string;
...
export type FeesForwardedEvent = TypedEvent<
  [string, FeeForwarder.FeeDistributionStructOutput[]],
...
export interface FeeForwarder extends BaseContract {
  ...
  functions: {
    ...
    forwardERC20Fees(
      ...
      _distributions: FeeForwarder.FeeDistributionStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "FeesForwarded(address,tuple[])"(
      token?: PromiseOrValue<string> | null,
      distributions?: null
    ): FeesForwardedEventFilter;
    FeesForwarded(
      token?: PromiseOrValue<string> | null,
      distributions?: null
    ): FeesForwardedEventFilter;
