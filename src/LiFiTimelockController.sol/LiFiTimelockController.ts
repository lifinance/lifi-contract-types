...
export type DiamondAddressUpdatedEventFilter =
  TypedEventFilter<DiamondAddressUpdatedEvent>;
...
export interface LiFiTimelockController extends BaseContract {
  ...
  filters: {
    ...
    "DiamondAddressUpdated(address)"(
      diamond?: PromiseOrValue<string> | null
    ): DiamondAddressUpdatedEventFilter;
