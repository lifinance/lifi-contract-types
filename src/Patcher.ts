...
export interface PatcherInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "depositAndExecuteWithDynamicPatches"
      | "depositAndExecuteWithMultiplePatches"
      | "executeWithDynamicPatches"
      | "executeWithMultiplePatches"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "depositAndExecuteWithDynamicPatches",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "depositAndExecuteWithMultiplePatches",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>[],
      PromiseOrValue<BytesLike>[],
  ...
  encodeFunctionData(
    functionFragment: "executeWithDynamicPatches",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "executeWithMultiplePatches",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BytesLike>[],
      PromiseOrValue<string>,
...
export interface Patcher extends BaseContract {
  ...
  functions: {
    depositAndExecuteWithDynamicPatches(
      ...
      valueSource: PromiseOrValue<string>,
      valueGetter: PromiseOrValue<BytesLike>,
      finalTarget: PromiseOrValue<string>,
    ...
    depositAndExecuteWithMultiplePatches(
      tokenAddress: PromiseOrValue<string>,
      valueSources: PromiseOrValue<string>[],
      valueGetters: PromiseOrValue<BytesLike>[],
      finalTarget: PromiseOrValue<string>,
      value: PromiseOrValue<BigNumberish>,
      data: PromiseOrValue<BytesLike>,
      offsetGroups: PromiseOrValue<BigNumberish>[][],
      delegateCall: PromiseOrValue<boolean>,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "PatchExecuted(address,address,uint256,bool,uint256)"(
      caller?: PromiseOrValue<string> | null,
      finalTarget?: PromiseOrValue<string> | null,
      value?: null,
      success?: null,
      returnDataLength?: null
    ): PatchExecutedEventFilter;
    PatchExecuted(
      caller?: PromiseOrValue<string> | null,
      finalTarget?: PromiseOrValue<string> | null,
      value?: null,
    ...
    "TokensDeposited(address,address,uint256,address)"(
      caller?: PromiseOrValue<string> | null,
