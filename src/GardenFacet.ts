...
export declare namespace GardenFacet {
  ...
  export type InitConfigStructOutput = [string, string, number] & {
    assetAddress: string;
    htlcAddress: string;
    assetType: number;
  };
  ...
  export type GardenDataStructOutput = [BigNumber, string] & {
    timelock: BigNumber;
    secretHash: string;
  };
}
...
export interface GardenFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initGarden",
    values: [GardenFacet.InitConfigStruct[]]
  ): string;
  encodeFunctionData(
...
export type GardenInitializedEventFilter =
  TypedEventFilter<GardenInitializedEvent>;
...
export interface GardenFacet extends BaseContract {
  ...
  functions: {
    initGarden(
      configs: GardenFacet.InitConfigStruct[],
