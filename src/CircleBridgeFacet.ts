...
export declare namespace CircleBridgeFacet {
  export type CircleBridgeDataStruct = {
    dstDomain: PromiseOrValue<BigNumberish>;
  };

  export type CircleBridgeDataStructOutput = [number] & { dstDomain: number };
}
...
export interface CircleBridgeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaCircleBridge",
    values: [ILiFi.BridgeDataStruct, CircleBridgeFacet.CircleBridgeDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaCircleBridge",
    values: [
...
export interface CircleBridgeFacet extends BaseContract {
  ...
  functions: {
    startBridgeTokensViaCircleBridge(
      ...
      _circleBridgeData: CircleBridgeFacet.CircleBridgeDataStruct,
