...
export interface AmarokFacetPackedInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "encode_startBridgeTokensViaAmarokERC20Packed"
      | "owner"
      | "pendingOwner"
      | "setApprovalForAmarokBridges"
      | "startBridgeTokensViaAmarokERC20Min"
  ...
  encodeFunctionData(
    functionFragment: "decode_startBridgeTokensViaAmarokERC20Packed",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "encode_startBridgeTokensViaAmarokERC20Packed",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "setApprovalForAmarokBridges",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaAmarokERC20Min",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaAmarokERC20Packed",
    values?: undefined
  ): string;
  encodeFunctionData(
