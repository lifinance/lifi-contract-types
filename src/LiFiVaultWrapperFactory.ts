...
export type WrapperDeployedEvent = TypedEvent<
  [string, string, string, string, string, string, number, BigNumber, string],
...
export interface LiFiVaultWrapperFactory extends BaseContract {
  ...
  filters: {
    ...
    "WrapperDeployed(address,bytes32,address,address,address,address,uint16,uint256,bytes32)"(
