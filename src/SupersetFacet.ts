...
export interface SupersetFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "unsetChainIdToEid",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export type ChainIdToEidUnsetEventFilter =
  TypedEventFilter<ChainIdToEidUnsetEvent>;
...
export interface SupersetFacet extends BaseContract {
  ...
  filters: {
    ...
    "ChainIdToEidUnset(uint256)"(
      chainId?: PromiseOrValue<BigNumberish> | null
    ): ChainIdToEidUnsetEventFilter;
    ChainIdToEidUnset(
      chainId?: PromiseOrValue<BigNumberish> | null
    ): ChainIdToEidUnsetEventFilter;
