...
export declare namespace DeBridgeFacet {
  export type SubmissionAutoParamsToStruct = {
  ...
  export type SubmissionAutoParamsToStructOutput = [
    BigNumber,
    BigNumber,
    string,
    string
...
export interface DeBridgeFacetInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaDeBridge",
    values: [ILiFi.BridgeDataStruct, DeBridgeFacet.DeBridgeDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaDeBridge",
    values: [
...
export interface DeBridgeFacet extends BaseContract {
  ...
  functions: {
    startBridgeTokensViaDeBridge(
      ...
      _deBridgeData: DeBridgeFacet.DeBridgeDataStruct,
