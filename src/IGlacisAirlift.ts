...
export interface IGlacisAirliftInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addSelectorsToToken",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "sendAfterApproval",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
...
export interface IGlacisAirlift extends BaseContract {
  ...
  functions: {
    addSelectorsToToken(
      diamondSelectors: PromiseOrValue<BytesLike>[],
      facetSelectors: PromiseOrValue<BytesLike>[],
