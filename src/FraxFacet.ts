...
export declare namespace FraxFacet {
  ...
  export type FraxDataStructOutput = [
    string,
    number,
    BigNumber,
    string,
...
export interface FraxFacetInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "FRAX_HOP"
      | "FRAX_PATH_USD"
      | "FRAX_TIP_FEE_MANAGER"
      | "getFraxChainIdToEid"
      | "initFrax"
      | "setFraxChainIdToEid"
      | "startBridgeTokensViaFrax"
      | "swapAndStartBridgeTokensViaFrax"
      | "unsetFraxChainIdToEid"
  ): FunctionFragment;

  encodeFunctionData(functionFragment: "FRAX_HOP", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "FRAX_PATH_USD",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "FRAX_TIP_FEE_MANAGER",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getFraxChainIdToEid",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "initFrax",
    values: [FraxFacet.ChainIdConfigStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setFraxChainIdToEid",
    values: [FraxFacet.ChainIdConfigStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaFrax",
    values: [ILiFi.BridgeDataStruct, FraxFacet.FraxDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaFrax",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "unsetFraxChainIdToEid",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "FraxChainMappingsInitialized"
  ): EventFragment;
...
export type FraxChainIdToEidSetEventFilter =
  TypedEventFilter<FraxChainIdToEidSetEvent>;
...
export type FraxChainIdToEidUnsetEventFilter =
  TypedEventFilter<FraxChainIdToEidUnsetEvent>;
...
export type FraxChainMappingsInitializedEventFilter =
  TypedEventFilter<FraxChainMappingsInitializedEvent>;
...
export interface FraxFacet extends BaseContract {
  ...
  functions: {
    ...
    initFrax(
      _chainIdConfigs: FraxFacet.ChainIdConfigStruct[],
    ...
    startBridgeTokensViaFrax(
      ...
      _fraxData: FraxFacet.FraxDataStruct,
  ...
  filters: {
    ...
    "FraxChainIdToEidSet(uint256,uint32)"(
      chainId?: PromiseOrValue<BigNumberish> | null,
      lzEid?: null
    ): FraxChainIdToEidSetEventFilter;
    FraxChainIdToEidSet(
      chainId?: PromiseOrValue<BigNumberish> | null,
      lzEid?: null
    ): FraxChainIdToEidSetEventFilter;

    "FraxChainIdToEidUnset(uint256)"(
      chainId?: PromiseOrValue<BigNumberish> | null
    ): FraxChainIdToEidUnsetEventFilter;
    FraxChainIdToEidUnset(
      chainId?: PromiseOrValue<BigNumberish> | null
    ): FraxChainIdToEidUnsetEventFilter;

    "FraxChainMappingsInitialized(tuple[])"(
      chainIdConfigs?: null
    ): FraxChainMappingsInitializedEventFilter;
    FraxChainMappingsInitialized(
      chainIdConfigs?: null
    ): FraxChainMappingsInitializedEventFilter;
