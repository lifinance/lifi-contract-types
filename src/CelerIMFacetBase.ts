...
export declare namespace CelerIMFacetBase {
  export type ZkLikeChainIdRelayerConfigStruct = {
    chainId: PromiseOrValue<BigNumberish>;
    relayer: PromiseOrValue<string>;
  };

  export type ZkLikeChainIdRelayerConfigStructOutput = [BigNumber, string] & {
    chainId: BigNumber;
    relayer: string;
  };
}
...
export interface CelerIMFacetBaseInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initCelerIM",
    values: [CelerIMFacetBase.ZkLikeChainIdRelayerConfigStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateRelayerConfigForZkLikeChains",
    values: [CelerIMFacetBase.ZkLikeChainIdRelayerConfigStruct[]]
  ): string;
...
export type CelerIMInitializedEvent = TypedEvent<
  [CelerIMFacetBase.ZkLikeChainIdRelayerConfigStructOutput[]],
  CelerIMInitializedEventObject
>;

export type CelerIMInitializedEventFilter =
  TypedEventFilter<CelerIMInitializedEvent>;

export interface CelerIMRelayerConfigEventObject {
  zkLikeChainIdRelayerConfigs: CelerIMFacetBase.ZkLikeChainIdRelayerConfigStructOutput[];
}
export type CelerIMRelayerConfigEvent = TypedEvent<
  [CelerIMFacetBase.ZkLikeChainIdRelayerConfigStructOutput[]],
  CelerIMRelayerConfigEventObject
>;

export type CelerIMRelayerConfigEventFilter =
  TypedEventFilter<CelerIMRelayerConfigEvent>;
...
export interface CelerIMFacetBase extends BaseContract {
  ...
  functions: {
    ...
    initCelerIM(
      configs: CelerIMFacetBase.ZkLikeChainIdRelayerConfigStruct[],
  ...
  filters: {
    "CelerIMInitialized(tuple[])"(
      zkLikeChainIdRelayerConfigs?: null
    ): CelerIMInitializedEventFilter;
    CelerIMInitialized(
      zkLikeChainIdRelayerConfigs?: null
    ): CelerIMInitializedEventFilter;

    "CelerIMRelayerConfig(tuple[])"(
      zkLikeChainIdRelayerConfigs?: null
    ): CelerIMRelayerConfigEventFilter;
    CelerIMRelayerConfig(
      zkLikeChainIdRelayerConfigs?: null
    ): CelerIMRelayerConfigEventFilter;
