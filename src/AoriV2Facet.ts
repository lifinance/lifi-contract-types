...
export declare namespace AoriV2Facet {
  export type AoriV2DataStruct = { exampleParam: PromiseOrValue<string> };

  export type AoriV2DataStructOutput = [string] & { exampleParam: string };
}
...
export interface AoriV2FacetInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "EXAMPLE"
      | "initAoriV2"
      | "startBridgeTokensViaAoriV2"
      | "swapAndStartBridgeTokensViaAoriV2"
  ): FunctionFragment;

  encodeFunctionData(functionFragment: "EXAMPLE", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "initAoriV2",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "startBridgeTokensViaAoriV2",
    values: [ILiFi.BridgeDataStruct, AoriV2Facet.AoriV2DataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "swapAndStartBridgeTokensViaAoriV2",
    values: [
...
export type AoriV2InitializedEvent = TypedEvent<
  [],
  AoriV2InitializedEventObject
>;

export type AoriV2InitializedEventFilter =
  TypedEventFilter<AoriV2InitializedEvent>;
...
export interface AoriV2Facet extends BaseContract {
  ...
  functions: {
    ...
    startBridgeTokensViaAoriV2(
      ...
      _aoriV2Data: AoriV2Facet.AoriV2DataStruct,
