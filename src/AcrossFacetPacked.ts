...
export interface AcrossFacetPackedInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "decode_startBridgeTokensViaAcrossNativePackedNoReferrer"
  ...
  encodeFunctionData(
    functionFragment: "containsReferrerId",
  ...
  encodeFunctionData(
    functionFragment: "decode_startBridgeTokensViaAcrossNativePackedNoReferrer",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
