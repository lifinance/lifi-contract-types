...
export interface LDADiamondLoupeFacetInterface extends utils.Interface {
    functions: {
...
export interface LDADiamondLoupeFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LDADiamondLoupeFacetInterface;
