...
export interface OFTWrapperFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaOFTWrapper((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint8,address,bytes32,uint256,uint256,address,bytes,(uint256,address,bytes2),bytes,address))": FunctionFragment;
        "swapAndStartBridgeTokensViaOFTWrapper((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint8,address,bytes32,uint256,uint256,address,bytes,(uint256,address,bytes2),bytes,address))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "batchWhitelist" | "estimateOFTFeesAndAmountOut" | "initOFTWrapper" | "setOFTLayerZeroChainId" | "startBridgeTokensViaOFTWrapper" | "swapAndStartBridgeTokensViaOFTWrapper"): FunctionFragment;
    encodeFunctionData(functionFragment: "batchWhitelist", values: [OFTWrapperFacet.WhitelistConfigStruct[]]): string;
    encodeFunctionData(functionFragment: "estimateOFTFeesAndAmountOut", values: [
    ...
    decodeFunctionResult(functionFragment: "estimateOFTFeesAndAmountOut", data: BytesLike): Result;
...
export interface OFTWrapperFacet extends BaseContract {
    ...
    functions: {
        ...
        estimateOFTFeesAndAmountOut(_sendingAssetId: PromiseOrValue<string>, _destinationChainId: PromiseOrValue<BigNumberish>, _amount: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<BytesLike>, _tokenType: PromiseOrValue<BigNumberish>, _useZro: PromiseOrValue<boolean>, _adapterParams: PromiseOrValue<BytesLike>, _callerBps: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
