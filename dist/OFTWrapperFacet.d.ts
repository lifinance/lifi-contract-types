...
export interface OFTWrapperFacetInterface extends utils.Interface {
    functions: {
        "estimateSendFee((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint8,address,bytes32,uint256,uint256,bytes))": FunctionFragment;
        "initOFTWrapper((uint256,uint16)[])": FunctionFragment;
        "setOFTLayerZeroChainId(uint256,uint16)": FunctionFragment;
        "startBridgeTokensViaOFTWrapper((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint8,address,bytes32,uint256,uint256,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaOFTWrapper((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint8,address,bytes32,uint256,uint256,bytes))": FunctionFragment;
    };
