...
export interface OFTWrapperFacetInterface extends utils.Interface {
    functions: {
        ...
        "estimateOFTFeesAndAmountOut(address,uint256,uint256,bytes32,bool,bytes,uint256)": FunctionFragment;
...
export interface OFTWrapperFacet extends BaseContract {
    ...
    functions: {
        ...
        estimateOFTFeesAndAmountOut(_sendingAssetId: PromiseOrValue<string>, _destinationChainId: PromiseOrValue<BigNumberish>, _amount: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<BytesLike>, _useZro: PromiseOrValue<boolean>, _adapterParams: PromiseOrValue<BytesLike>, _callerBps: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
