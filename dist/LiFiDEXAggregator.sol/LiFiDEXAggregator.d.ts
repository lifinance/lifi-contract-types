...
export interface LiFiDEXAggregatorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "agniSwapCallback" | "algebraSwapCallback" | "bentoBox" | "dragonswapV2SwapCallback" | "fusionXV3SwapCallback" | "owner" | "pancakeV3SwapCallback" | "pause" | "priviledgedUsers" | "processRoute" | "ramsesV2SwapCallback" | "renounceOwnership" | "resume" | "setPriviledge" | "supV3SwapCallback" | "transferOwnership" | "transferValueAndprocessRoute" | "uniswapV3SwapCallback" | "vvsV3SwapCallback" | "xeiV3SwapCallback" | "zebraV3SwapCallback"): FunctionFragment;
