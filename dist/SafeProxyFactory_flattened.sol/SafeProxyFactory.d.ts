...
export interface SafeProxyFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createChainSpecificProxyWithNonce" | "createProxyWithCallback" | "createProxyWithCallbackL2" | "createProxyWithNonce" | "createProxyWithNonceL2" | "getChainId" | "proxyCreationCode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createProxyWithCallbackL2", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ...
    encodeFunctionData(functionFragment: "createProxyWithNonceL2", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    decodeFunctionResult(functionFragment: "createProxyWithCallbackL2", data: BytesLike): Result;
...
export declare type ProxyCreationL2Event = TypedEvent<[
    string,
    string,
    string,
    BigNumber
], ProxyCreationL2EventObject>;
export declare type ProxyCreationL2EventFilter = TypedEventFilter<ProxyCreationL2Event>;
export interface SafeProxyFactory extends BaseContract {
    ...
    functions: {
        ...
        createProxyWithCallbackL2(_singleton: PromiseOrValue<string>, initializer: PromiseOrValue<BytesLike>, saltNonce: PromiseOrValue<BigNumberish>, callback: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        createProxyWithNonceL2(_singleton: PromiseOrValue<string>, initializer: PromiseOrValue<BytesLike>, saltNonce: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        createProxyWithCallbackL2(_singleton: PromiseOrValue<string>, initializer: PromiseOrValue<BytesLike>, saltNonce: PromiseOrValue<BigNumberish>, callback: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        ...
        createProxyWithNonceL2(_singleton: PromiseOrValue<string>, initializer: PromiseOrValue<BytesLike>, saltNonce: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        proxyCreationCode(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        ...
        "ProxyCreationL2(address,address,bytes,uint256)"(proxy?: PromiseOrValue<string> | null, singleton?: null, initializer?: null, saltNonce?: null): ProxyCreationL2EventFilter;
        ProxyCreationL2(proxy?: PromiseOrValue<string> | null, singleton?: null, initializer?: null, saltNonce?: null): ProxyCreationL2EventFilter;
    };
    estimateGas: {
        createChainSpecificProxyWithNonce(_singleton: PromiseOrValue<string>, initializer: PromiseOrValue<BytesLike>, saltNonce: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
