...
export interface MayanBridgeFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaMayanBridge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,uint16,bytes32,bytes32,bytes32,uint64,uint64,uint64,uint256,uint64,uint64,bool,uint64))": FunctionFragment;
        "swapAndStartBridgeTokensViaMayanBridge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,uint16,bytes32,bytes32,bytes32,uint64,uint64,uint64,uint256,uint64,uint64,bool,uint64))": FunctionFragment;
    };
