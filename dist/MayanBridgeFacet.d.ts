...
export interface MayanBridgeFacetInterface extends utils.Interface {
    functions: {
        "initMayanBridge((uint256,uint16)[])": FunctionFragment;
        "mayanBridge()": FunctionFragment;
        "setMayanChainIdMapping(uint256,uint16)": FunctionFragment;
        "startBridgeTokensViaMayanBridge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,bytes32,bytes32,bytes32,uint64,uint64,uint64,uint256,uint64,uint64,bool,uint64))": FunctionFragment;
        "swapAndStartBridgeTokensViaMayanBridge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,bytes32,bytes32,bytes32,uint64,uint64,uint64,uint256,uint64,uint64,bool,uint64))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "initMayanBridge" | "mayanBridge" | "setMayanChainIdMapping" | "startBridgeTokensViaMayanBridge" | "swapAndStartBridgeTokensViaMayanBridge"): FunctionFragment;
    encodeFunctionData(functionFragment: "initMayanBridge", values: [MayanBridgeFacet.ConfigStruct[]]): string;
...
export interface MayanInitializedEventObject {
    configs: MayanBridgeFacet.ConfigStructOutput[];
}
export declare type MayanInitializedEvent = TypedEvent<[
    MayanBridgeFacet.ConfigStructOutput[]
...
export interface MayanBridgeFacet extends BaseContract {
    ...
    functions: {
        initMayanBridge(configs: MayanBridgeFacet.ConfigStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        initMayanBridge(configs: MayanBridgeFacet.ConfigStruct[], overrides?: CallOverrides): Promise<void>;
        mayanBridge(overrides?: CallOverrides): Promise<string>;
