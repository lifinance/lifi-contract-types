...
export interface IMessageBusInterface extends utils.Interface {
    ...
    decodeFunctionResult(functionFragment: "sendMessage(bytes,uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sendMessage(address,uint256,bytes)", data: BytesLike): Result;
...
//# sourceMappingURL=IMessageBus.d.ts.map