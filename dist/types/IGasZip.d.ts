...
export interface IGasZip extends BaseContract {
    ...
    functions: {
        deposit(destinationChains: BigNumberish, to: BytesLike, overrides?: PayableOverrides & {
            from?: string;
    ...
    callStatic: {
        deposit(destinationChains: BigNumberish, to: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        deposit(destinationChains: BigNumberish, to: BytesLike, overrides?: PayableOverrides & {
...
//# sourceMappingURL=IGasZip.d.ts.map