...
export interface LiFiTimelockControllerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setDiamondAddress", values: [string]): string;
...
export interface LiFiTimelockController extends BaseContract {
    ...
    functions: {
        ...
        setDiamondAddress(_diamond: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setDiamondAddress(_diamond: string, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {
        ...
        "DiamondAddressUpdated(address)"(diamond?: string | null): DiamondAddressUpdatedEventFilter;
        DiamondAddressUpdated(diamond?: string | null): DiamondAddressUpdatedEventFilter;
...
//# sourceMappingURL=LiFiTimelockController.d.ts.map