...
export interface FusePoolZapTestInterface extends utils.Interface {
    functions: {
        "IS_TEST()": FunctionFragment;
        "failed()": FunctionFragment;
        "setUp()": FunctionFragment;
        "testCanZapIn()": FunctionFragment;
        "testCanZapInWithEth()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "testCanZapIn" | "testCanZapInWithEth"): FunctionFragment;
    encodeFunctionData(functionFragment: "IS_TEST", values?: undefined): string;
    encodeFunctionData(functionFragment: "failed", values?: undefined): string;
    encodeFunctionData(functionFragment: "setUp", values?: undefined): string;
    encodeFunctionData(functionFragment: "testCanZapIn", values?: undefined): string;
    encodeFunctionData(functionFragment: "testCanZapInWithEth", values?: undefined): string;
    decodeFunctionResult(functionFragment: "IS_TEST", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "failed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUp", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCanZapIn", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCanZapInWithEth", data: BytesLike): Result;
    events: {
...
export interface FusePoolZapTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FusePoolZapTestInterface;
    ...
    functions: {
        ...
        testCanZapIn(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCanZapInWithEth(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        testCanZapIn(overrides?: CallOverrides): Promise<void>;
        testCanZapInWithEth(overrides?: CallOverrides): Promise<void>;
    };
    filters: {
