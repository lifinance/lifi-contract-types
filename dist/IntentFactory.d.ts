...
export interface IntentFactoryInterface extends utils.Interface {
    functions: {
        ...
        "deployAndExecuteIntent((bytes32,address,address,address,uint256,uint256),(address,uint256,bytes)[])": FunctionFragment;
        "deployAndWithdrawAll((bytes32,address,address,address,uint256,uint256),address[],address)": FunctionFragment;
        "getIntentAddress((bytes32,address,address,address,uint256,uint256))": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "deployAndWithdrawAll", values: [
        IIntent.InitDataStruct,
...
export interface IntentFactory extends BaseContract {
    ...
    functions: {
        ...
        deployAndWithdrawAll(_initData: IIntent.InitDataStruct, tokens: PromiseOrValue<string>[], receiver: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deployAndWithdrawAll(_initData: IIntent.InitDataStruct, tokens: PromiseOrValue<string>[], receiver: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        getIntentAddress(_initData: IIntent.InitDataStruct, overrides?: CallOverrides): Promise<string>;
        implementation(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
        pendingOwner(overrides?: CallOverrides): Promise<string>;
