...
export interface IntentFactoryInterface extends utils.Interface {
    functions: {
        ...
        "deployAndExecuteIntent((bytes32,address,address,uint256,uint256),(address,uint256,bytes)[])": FunctionFragment;
        "deployAndWithdrawAll((bytes32,address,address,uint256,uint256),address[])": FunctionFragment;
        "getIntentAddress((bytes32,address,address,uint256,uint256))": FunctionFragment;
