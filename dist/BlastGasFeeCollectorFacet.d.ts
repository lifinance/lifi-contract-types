...
export interface BlastGasFeeCollectorFacetInterface extends utils.Interface {
    functions: {
        ...
        "claimGasFees(address)": FunctionFragment;
        "configureGasMode()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "BLAST" | "claimGasFees" | "configureGasMode"): FunctionFragment;
    encodeFunctionData(functionFragment: "BLAST", values?: undefined): string;
    encodeFunctionData(functionFragment: "claimGasFees", values: [PromiseOrValue<string>]): string;
...
export interface BlastGasFeeCollectorFacet extends BaseContract {
    ...
    functions: {
        ...
        claimGasFees(recipient: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        BLAST(overrides?: CallOverrides): Promise<string>;
        claimGasFees(recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
