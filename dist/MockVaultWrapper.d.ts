...
export interface MockVaultWrapperInterface extends utils.Interface {
    functions: {
        ...
        "initialize(address,address,address,address,(uint16[4],bool[4]),bytes)": FunctionFragment;
        "initialized()": FunctionFragment;
        "integrator()": FunctionFragment;
        "underlying()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "adapter" | "asset" | "feeEnabled" | "feeRate" | "initData" | "initialize" | "initialized" | "integrator" | "underlying"): FunctionFragment;
...
export interface MockVaultWrapper extends BaseContract {
    ...
    functions: {
        ...
        initialize(_asset: PromiseOrValue<string>, _underlying: PromiseOrValue<string>, _adapter: PromiseOrValue<string>, _integrator: PromiseOrValue<string>, _fees: FeeConfigStruct, _initData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        feeRate(_feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<number>;
        initData(overrides?: CallOverrides): Promise<string>;
        initialize(_asset: PromiseOrValue<string>, _underlying: PromiseOrValue<string>, _adapter: PromiseOrValue<string>, _integrator: PromiseOrValue<string>, _fees: FeeConfigStruct, _initData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        initialized(overrides?: CallOverrides): Promise<boolean>;
        integrator(overrides?: CallOverrides): Promise<string>;
        underlying(overrides?: CallOverrides): Promise<string>;
    };
