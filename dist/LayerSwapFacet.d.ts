...
export declare namespace LayerSwapFacet {
    type LayerSwapDataStruct = {
        requestId: PromiseOrValue<BytesLike>;
        nonEVMReceiver: PromiseOrValue<BytesLike>;
    };
    type LayerSwapDataStructOutput = [string, string] & {
        requestId: string;
...
export interface LayerSwapFacetInterface extends utils.Interface {
    functions: {
        "LAYERSWAP_TARGET()": FunctionFragment;
        "consumedIds(bytes32)": FunctionFragment;
        "startBridgeTokensViaLayerSwap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaLayerSwap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,bytes32))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "LAYERSWAP_TARGET" | "consumedIds" | "startBridgeTokensViaLayerSwap" | "swapAndStartBridgeTokensViaLayerSwap"): FunctionFragment;
    encodeFunctionData(functionFragment: "LAYERSWAP_TARGET", values?: undefined): string;
    encodeFunctionData(functionFragment: "consumedIds", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaLayerSwap", values: [ILiFi.BridgeDataStruct, LayerSwapFacet.LayerSwapDataStruct]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaLayerSwap", values: [
        ILiFi.BridgeDataStruct,
        LibSwap.SwapDataStruct[],
        LayerSwapFacet.LayerSwapDataStruct
    ]): string;
    decodeFunctionResult(functionFragment: "LAYERSWAP_TARGET", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "consumedIds", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "startBridgeTokensViaLayerSwap", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapAndStartBridgeTokensViaLayerSwap", data: BytesLike): Result;
    events: {
...
export interface LayerSwapFacet extends BaseContract {
    ...
    functions: {
        LAYERSWAP_TARGET(overrides?: CallOverrides): Promise<[string]>;
        consumedIds(_requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[boolean]>;
        startBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    LAYERSWAP_TARGET(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        LAYERSWAP_TARGET(overrides?: CallOverrides): Promise<string>;
        consumedIds(_requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        startBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    estimateGas: {
        LAYERSWAP_TARGET(overrides?: CallOverrides): Promise<BigNumber>;
        consumedIds(_requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        startBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        swapAndStartBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        LAYERSWAP_TARGET(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        consumedIds(_requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
