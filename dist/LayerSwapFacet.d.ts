...
export declare namespace LayerSwapFacet {
    ...
    type LayerSwapDataStructOutput = [
        string,
        string,
        string,
        string,
...
export interface LayerSwapFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaLayerSwap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,address,bytes32,bytes,uint256))": FunctionFragment;
        "swapAndStartBridgeTokensViaLayerSwap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,address,bytes32,bytes,uint256))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "LAYERSWAP_DEPOSITORY" | "startBridgeTokensViaLayerSwap" | "swapAndStartBridgeTokensViaLayerSwap"): FunctionFragment;
    encodeFunctionData(functionFragment: "LAYERSWAP_DEPOSITORY", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "LAYERSWAP_DEPOSITORY", data: BytesLike): Result;
...
export interface LayerSwapFacet extends BaseContract {
    ...
    populateTransaction: {
        LAYERSWAP_DEPOSITORY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaLayerSwap(_bridgeData: ILiFi.BridgeDataStruct, _layerSwapData: LayerSwapFacet.LayerSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
