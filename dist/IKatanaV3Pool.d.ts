...
export interface IKatanaV3PoolInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "fee" | "governance" | "swap" | "token0" | "token1"): FunctionFragment;
...
export interface IKatanaV3Pool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IKatanaV3PoolInterface;
