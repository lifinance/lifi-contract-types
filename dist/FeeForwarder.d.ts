...
export interface FeeForwarder extends BaseContract {
    ...
    functions: {
        ...
        forwardERC20Fees(token: PromiseOrValue<string>, distributions: FeeForwarder.FeeDistributionStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        forwardERC20Fees(token: PromiseOrValue<string>, distributions: FeeForwarder.FeeDistributionStruct[], overrides?: CallOverrides): Promise<void>;
