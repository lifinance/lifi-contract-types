...
export interface GasZipPeripheryInterface extends utils.Interface {
    functions: {
        ...
        "depositToGasZipNative((uint256),address)": FunctionFragment;
        "gasZipRouter()": FunctionFragment;
        "getDestinationChainsValue(uint8[])": FunctionFragment;
        "liFiDEXAggregator()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "depositToGasZipERC20" | "depositToGasZipNative" | "gasZipRouter" | "getDestinationChainsValue" | "liFiDEXAggregator"): FunctionFragment;
    encodeFunctionData(functionFragment: "depositToGasZipERC20", values: [
        LibSwap.SwapDataStruct,
        IGasZip.GasZipDataStruct,
        PromiseOrValue<string>
    ]): string;
    encodeFunctionData(functionFragment: "depositToGasZipNative", values: [IGasZip.GasZipDataStruct, PromiseOrValue<string>]): string;
    ...
    events: {
        "DepositedToGasZip(uint256)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "DepositedToGasZip"): EventFragment;
...
export interface DepositedToGasZipEventObject {
    amount: BigNumber;
}
export declare type DepositedToGasZipEvent = TypedEvent<[
    BigNumber
], DepositedToGasZipEventObject>;
export declare type DepositedToGasZipEventFilter = TypedEventFilter<DepositedToGasZipEvent>;
...
export interface GasZipPeriphery extends BaseContract {
    ...
    functions: {
        depositToGasZipERC20(_swapData: LibSwap.SwapDataStruct, _gasZipData: IGasZip.GasZipDataStruct, _receiver: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        depositToGasZipNative(_gasZipData: IGasZip.GasZipDataStruct, _receiver: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    liFiDEXAggregator(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        depositToGasZipERC20(_swapData: LibSwap.SwapDataStruct, _gasZipData: IGasZip.GasZipDataStruct, _receiver: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        depositToGasZipNative(_gasZipData: IGasZip.GasZipDataStruct, _receiver: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        gasZipRouter(overrides?: CallOverrides): Promise<string>;
        getDestinationChainsValue(_chainIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
        liFiDEXAggregator(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        "DepositedToGasZip(uint256)"(amount?: null): DepositedToGasZipEventFilter;
        DepositedToGasZip(amount?: null): DepositedToGasZipEventFilter;
