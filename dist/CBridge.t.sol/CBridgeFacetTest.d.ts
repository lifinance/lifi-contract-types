...
export interface CBridgeFacetTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "testRevert_WillRevertIfNotEnoughMsgValue", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testRevert_WillRevertIfNotEnoughMsgValue", data: BytesLike): Result;
...
export interface CBridgeFacetTest extends BaseContract {
    ...
    functions: {
        ...
        testRevert_WillRevertIfNotEnoughMsgValue(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        testRevert_WillRevertIfNotEnoughMsgValue(overrides?: CallOverrides): Promise<void>;
        vm(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
