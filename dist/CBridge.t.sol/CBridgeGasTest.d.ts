...
export interface CBridgeGasTestInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "testDirectBridge" | "testLifiBridge"): FunctionFragment;
...
export interface CBridgeGasTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CBridgeGasTestInterface;
