...
export declare namespace ISponsoredCCTPSrcPeriphery {
    ...
    type SponsoredCCTPQuoteStructOutput = [
        number,
        number,
        string,
        BigNumber,
...
export interface ISponsoredCCTPSrcPeripheryInterface extends utils.Interface {
    functions: {
        "depositForBurn((uint32,uint32,bytes32,uint256,bytes32,bytes32,uint256,uint32,bytes32,uint256,uint256,uint256,bytes32,bytes32,uint32,uint8,uint8,bytes),bytes)": FunctionFragment;
    };
...
export interface ISponsoredCCTPSrcPeriphery extends BaseContract {
    ...
    functions: {
        depositForBurn(quote: ISponsoredCCTPSrcPeriphery.SponsoredCCTPQuoteStruct, signature: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        depositForBurn(quote: ISponsoredCCTPSrcPeriphery.SponsoredCCTPQuoteStruct, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        depositForBurn(quote: ISponsoredCCTPSrcPeriphery.SponsoredCCTPQuoteStruct, signature: PromiseOrValue<BytesLike>, overrides?: Overrides & {
