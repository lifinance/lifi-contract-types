...
export interface NEARIntentsFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaNEARIntents((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,bytes32,bytes32,uint256,uint256,address,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaNEARIntents((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,bytes32,bytes32,uint256,uint256,address,bytes))": FunctionFragment;
    };
