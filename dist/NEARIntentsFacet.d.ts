...
export interface NEARIntentsFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaNEARIntents((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,address,uint256,uint256,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaNEARIntents((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,address,uint256,uint256,bytes))": FunctionFragment;
    };
