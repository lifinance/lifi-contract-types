...
export interface AmarokFacetTestInterface extends utils.Interface {
    functions: {
...
export interface AmarokFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AmarokFacetTestInterface;
