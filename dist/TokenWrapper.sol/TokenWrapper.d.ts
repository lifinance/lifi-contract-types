...
export interface TokenWrapperInterface extends utils.Interface {
    functions: {
        ...
        "externalWrapper()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "deposit" | "externalWrapper" | "owner" | "pendingOwner" | "transferOwnership" | "withdraw" | "wrappedToken"): FunctionFragment;
    encodeFunctionData(functionFragment: "cancelOwnershipTransfer", values?: undefined): string;
    encodeFunctionData(functionFragment: "confirmOwnershipTransfer", values?: undefined): string;
    encodeFunctionData(functionFragment: "deposit", values?: undefined): string;
    encodeFunctionData(functionFragment: "externalWrapper", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "externalWrapper", data: BytesLike): Result;
...
export declare type UnwrappedEvent = TypedEvent<[BigNumber], UnwrappedEventObject>;
export declare type UnwrappedEventFilter = TypedEventFilter<UnwrappedEvent>;
export interface WrappedEventObject {
    amount: BigNumber;
}
export declare type WrappedEvent = TypedEvent<[BigNumber], WrappedEventObject>;
export declare type WrappedEventFilter = TypedEventFilter<WrappedEvent>;
export interface TokenWrapper extends BaseContract {
    ...
    functions: {
        ...
        externalWrapper(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        externalWrapper(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        externalWrapper(overrides?: CallOverrides): Promise<PopulatedTransaction>;
