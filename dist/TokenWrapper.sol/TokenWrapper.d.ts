...
export interface TokenWrapperInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "deposit" | "owner" | "pendingOwner" | "transferOwnership" | "withdraw" | "wrappedToken"): FunctionFragment;
