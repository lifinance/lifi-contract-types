...
export interface ThorSwapFacetInterface extends utils.Interface {
    functions: {
        ...
        "thorchainRouter()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "startBridgeTokensViaThorSwap" | "swapAndStartBridgeTokensViaThorSwap" | "thorchainRouter"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "thorchainRouter", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "thorchainRouter", data: BytesLike): Result;
    events: {
...
export interface ThorSwapFacet extends BaseContract {
    ...
    functions: {
        ...
        thorchainRouter(overrides?: CallOverrides): Promise<[string]>;
    };
    startBridgeTokensViaThorSwap(_bridgeData: ILiFi.BridgeDataStruct, _thorSwapData: ThorSwapFacet.ThorSwapDataStruct, overrides?: PayableOverrides & {
        from?: PromiseOrValue<string>;
    }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        thorchainRouter(overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        startBridgeTokensViaThorSwap(_bridgeData: ILiFi.BridgeDataStruct, _thorSwapData: ThorSwapFacet.ThorSwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        ...
        thorchainRouter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
