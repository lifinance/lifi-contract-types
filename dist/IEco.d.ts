...
export interface IEcoInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "fulfill" | "fund" | "prove" | "publish" | "refund" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "publish", values: [PromiseOrValue<BigNumberish>, IEco.RouteStruct, IEco.RewardStruct]): string;
...
export interface IEco extends BaseContract {
    ...
    functions: {
        fulfill(intentHash: PromiseOrValue<BytesLike>, route: IEco.RouteStruct, rewardHash: PromiseOrValue<BytesLike>, claimant: PromiseOrValue<string>, overrides?: Overrides & {
        ...
        prove(prover: PromiseOrValue<string>, sourceChainDomainID: PromiseOrValue<BigNumberish>, intentHashes: PromiseOrValue<BytesLike>[], data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        publish(destination: PromiseOrValue<BigNumberish>, route: IEco.RouteStruct, reward: IEco.RewardStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        refund(destination: PromiseOrValue<BigNumberish>, routeHash: PromiseOrValue<BytesLike>, reward: IEco.RewardStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        withdraw(destination: PromiseOrValue<BigNumberish>, routeHash: PromiseOrValue<BytesLike>, reward: IEco.RewardStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    fulfill(intentHash: PromiseOrValue<BytesLike>, route: IEco.RouteStruct, rewardHash: PromiseOrValue<BytesLike>, claimant: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        fulfill(intentHash: PromiseOrValue<BytesLike>, route: IEco.RouteStruct, rewardHash: PromiseOrValue<BytesLike>, claimant: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string[]>;
        ...
        prove(prover: PromiseOrValue<string>, sourceChainDomainID: PromiseOrValue<BigNumberish>, intentHashes: PromiseOrValue<BytesLike>[], data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        publish(destination: PromiseOrValue<BigNumberish>, route: IEco.RouteStruct, reward: IEco.RewardStruct, overrides?: CallOverrides): Promise<[string, string] & {
            intentHash: string;
            vault: string;
        }>;
        refund(destination: PromiseOrValue<BigNumberish>, routeHash: PromiseOrValue<BytesLike>, reward: IEco.RewardStruct, overrides?: CallOverrides): Promise<void>;
        withdraw(destination: PromiseOrValue<BigNumberish>, routeHash: PromiseOrValue<BytesLike>, reward: IEco.RewardStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        fulfill(intentHash: PromiseOrValue<BytesLike>, route: IEco.RouteStruct, rewardHash: PromiseOrValue<BytesLike>, claimant: PromiseOrValue<string>, overrides?: Overrides & {
