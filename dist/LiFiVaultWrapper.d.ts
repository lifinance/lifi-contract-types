...
export interface LiFiVaultWrapperInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptOwnership" | "accessGate" | "adapter" | "allowance" | "approve" | "asset" | "balanceOf" | "convertToAssets" | "convertToShares" | "decimals" | "deposit" | "depositsPaused" | "distributeFees" | "factory" | "feeEnabled" | "feeRate" | "initialize" | "initialized" | "integratorFeeAssets" | "integratorFeeReceivers" | "integratorFeeShares" | "integratorShareBps" | "lastMgmtAccrual" | "lifiFeeAssets" | "lifiFeeShares" | "maxDeposit" | "maxMint" | "maxRedeem" | "maxWithdraw" | "mint" | "name" | "owner" | "pause" | "paused" | "pendingOwner" | "perfHighWaterMarkPps" | "previewDeposit" | "previewMint" | "previewRedeem" | "previewWithdraw" | "redeem" | "renounceOwnership" | "setAccessGate" | "setFeeRate" | "setIntegratorFeeReceivers" | "symbol" | "totalAssets" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "underlying" | "unpause" | "withdraw"): FunctionFragment;
