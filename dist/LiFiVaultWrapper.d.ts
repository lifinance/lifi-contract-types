...
export interface LiFiVaultWrapperInterface extends utils.Interface {
    functions: {
        ...
        "integratorReceivers(uint256)": FunctionFragment;
        ...
        "setIntegratorReceivers(address[],uint16[])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "acceptOwnership" | "adapter" | "allowance" | "approve" | "asset" | "balanceOf" | "convertToAssets" | "convertToShares" | "decimals" | "deposit" | "depositsPaused" | "factory" | "feeEnabled" | "feeRate" | "initData" | "initialize" | "initialized" | "integratorFeeAssets" | "integratorFeeShares" | "integratorReceivers" | "integratorShareBps" | "lastMgmtAccrual" | "lifiFeeAssets" | "lifiFeeShares" | "maxDeposit" | "maxMint" | "maxRedeem" | "maxWithdraw" | "mint" | "name" | "owner" | "pause" | "paused" | "pendingOwner" | "perfHighWaterMarkPps" | "previewDeposit" | "previewMint" | "previewRedeem" | "previewWithdraw" | "redeem" | "renounceOwnership" | "setFeeRate" | "setIntegratorReceivers" | "sweep" | "symbol" | "totalAssets" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "underlying" | "unpause" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "integratorReceivers", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "setIntegratorReceivers", values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]): string;
    ...
    decodeFunctionResult(functionFragment: "integratorReceivers", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setIntegratorReceivers", data: BytesLike): Result;
    ...
    events: {
        ...
        "ReceiversSet(address[],uint16[])": EventFragment;
        "ReservoirSwept(address,uint256,uint256)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ReservoirSwept"): EventFragment;
...
export interface ReservoirSweptEventObject {
    token: string;
    lifiAmount: BigNumber;
    integratorAmount: BigNumber;
}
export type ReservoirSweptEvent = TypedEvent<[
    string,
    BigNumber,
    BigNumber
], ReservoirSweptEventObject>;
export type ReservoirSweptEventFilter = TypedEventFilter<ReservoirSweptEvent>;
...
export interface LiFiVaultWrapper extends BaseContract {
    ...
    functions: {
        ...
        initialize(_underlying: PromiseOrValue<string>, _adapter: PromiseOrValue<string>, _vaultWrapperAdmin: PromiseOrValue<string>, _integratorShareBps: [
            ...
            PromiseOrValue<BigNumberish>,
            PromiseOrValue<BigNumberish>
        ], _fees: FeeConfigStruct, _receivers: IntegratorReceiversStruct, _initData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        integratorReceivers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, number] & {
            wallet: string;
            bps: number;
        }>;
        ...
        setIntegratorReceivers(_receivers: PromiseOrValue<string>[], _receiverBps: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_underlying: PromiseOrValue<string>, _adapter: PromiseOrValue<string>, _vaultWrapperAdmin: PromiseOrValue<string>, _integratorShareBps: [
            ...
            PromiseOrValue<BigNumberish>,
            PromiseOrValue<BigNumberish>
        ], _fees: FeeConfigStruct, _receivers: IntegratorReceiversStruct, _initData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        initialized(overrides?: CallOverrides): Promise<boolean>;
        integratorFeeAssets(overrides?: CallOverrides): Promise<BigNumber>;
        integratorFeeShares(overrides?: CallOverrides): Promise<BigNumber>;
        integratorReceivers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, number] & {
        ...
        setIntegratorReceivers(_receivers: PromiseOrValue<string>[], _receiverBps: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "ReceiversSet(address[],uint16[])"(receivers?: null, bps?: null): ReceiversSetEventFilter;
        ReceiversSet(receivers?: null, bps?: null): ReceiversSetEventFilter;
        "ReservoirSwept(address,uint256,uint256)"(token?: PromiseOrValue<string> | null, lifiAmount?: null, integratorAmount?: null): ReservoirSweptEventFilter;
        ReservoirSwept(token?: PromiseOrValue<string> | null, lifiAmount?: null, integratorAmount?: null): ReservoirSweptEventFilter;
    ...
    estimateGas: {
        ...
        integratorFeeAssets(overrides?: CallOverrides): Promise<BigNumber>;
        integratorFeeShares(overrides?: CallOverrides): Promise<BigNumber>;
        integratorReceivers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        integratorReceivers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
