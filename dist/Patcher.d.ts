...
export interface Patcher extends BaseContract {
    ...
    functions: {
        depositAndExecuteWithDynamicPatches(tokenAddress: PromiseOrValue<string>, valueSource: PromiseOrValue<string>, valueGetter: PromiseOrValue<BytesLike>, finalTarget: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, offsets: PromiseOrValue<BigNumberish>[], delegateCall: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        depositAndExecuteWithMultiplePatches(tokenAddress: PromiseOrValue<string>, valueSources: PromiseOrValue<string>[], valueGetters: PromiseOrValue<BytesLike>[], finalTarget: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, offsetGroups: PromiseOrValue<BigNumberish>[][], delegateCall: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
