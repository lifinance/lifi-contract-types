...
export interface TestHyphenFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaHyphen" | "swapAndStartBridgeTokensViaHyphen"): FunctionFragment;
...
export interface TestHyphenFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestHyphenFacetInterface;
