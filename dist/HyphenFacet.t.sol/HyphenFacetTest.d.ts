...
export interface HyphenFacetTestInterface extends utils.Interface {
    functions: {
...
export interface HyphenFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HyphenFacetTestInterface;
