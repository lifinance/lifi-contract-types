...
export interface IDexManagerFacetInterface extends utils.Interface {
    functions: {
        ...
        "isDexApproved(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "approvedDexs" | "batchAddDex" | "batchRemoveDex" | "batchSetFunctionApprovalBySignature" | "isDexApproved" | "isFunctionApproved" | "removeDex" | "setFunctionApprovalBySignature"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "isDexApproved", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "isDexApproved", data: BytesLike): Result;
...
export interface IDexManagerFacet extends BaseContract {
    ...
    functions: {
        ...
        isDexApproved(_contract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean] & {
            approved: boolean;
        }>;
    ...
    estimateGas: {
        ...
        isDexApproved(_contract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isDexApproved(_contract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
