...
export interface TestGravityFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaGravity" | "swapAndStartBridgeTokensViaGravity"): FunctionFragment;
...
export interface TestGravityFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestGravityFacetInterface;
