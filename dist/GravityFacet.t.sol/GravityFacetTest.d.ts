...
export interface GravityFacetTestInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "test_revert_BridgeNativeAsset", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_revert_BridgeNativeAsset", data: BytesLike): Result;
...
export interface GravityFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GravityFacetTestInterface;
    ...
    functions: {
        ...
        test_revert_BridgeNativeAsset(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        test_revert_BridgeNativeAsset(overrides?: CallOverrides): Promise<void>;
        vm(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
