...
export interface LDAOwnershipFacetInterface extends utils.Interface {
    functions: {
...
export interface LDAOwnershipFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LDAOwnershipFacetInterface;
