...
export interface LidoWrapperInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ST_ETH" | "WST_ETH_ADDRESS" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "owner" | "pendingOwner" | "transferOwnership" | "unwrapWstETHToStETH" | "withdrawToken" | "wrapStETHToWstETH"): FunctionFragment;
...
export interface LidoWrapper extends BaseContract {
    ...
    callStatic: {
        ...
        unwrapWstETHToStETH(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        wrapStETHToWstETH(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
