...
export interface IStETHInterface extends utils.Interface {
    functions: {
        ...
        "unwrapShares(uint256)": FunctionFragment;
        "wrap(uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "totalSupply" | "transfer" | "transferFrom" | "unwrap" | "unwrapShares" | "wrap"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "unwrapShares", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "unwrapShares", data: BytesLike): Result;
...
export interface IStETH extends BaseContract {
    ...
    functions: {
        ...
        unwrapShares(amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        unwrapShares(amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
