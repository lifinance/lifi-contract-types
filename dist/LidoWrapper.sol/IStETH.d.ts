...
export interface IStETHInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "totalSupply" | "transfer" | "transferFrom" | "unwrap" | "wrap"): FunctionFragment;
...
export interface IStETH extends BaseContract {
    ...
    callStatic: {
        ...
        unwrap(amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        wrap(amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
