...
export interface GasZipInterface extends utils.Interface {
    functions: {
        ...
        "zipERC20(address,uint256,uint256,address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "ZERO" | "allowToken" | "allowedInboundTokens" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "gasZipRouter" | "owner" | "pendingOwner" | "transferOwnership" | "uniswapRouter" | "zip" | "zipERC20"): FunctionFragment;
    encodeFunctionData(functionFragment: "ZERO", values?: undefined): string;
    encodeFunctionData(functionFragment: "allowToken", values: [PromiseOrValue<string>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "allowedInboundTokens", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "allowedInboundTokens", data: BytesLike): Result;
...
export interface GasZip extends BaseContract {
    ...
    functions: {
        ...
        allowToken(token: PromiseOrValue<string>, allowed: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        allowedInboundTokens(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        zipERC20(fromToken: PromiseOrValue<string>, minAmount: PromiseOrValue<BigNumberish>, destinationChain: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    ZERO(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ZERO(overrides?: CallOverrides): Promise<string>;
        allowToken(token: PromiseOrValue<string>, allowed: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        allowedInboundTokens(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        ...
        zipERC20(fromToken: PromiseOrValue<string>, minAmount: PromiseOrValue<BigNumberish>, destinationChain: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        allowedInboundTokens(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        cancelOwnershipTransfer(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        confirmOwnershipTransfer(overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        allowedInboundTokens(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        cancelOwnershipTransfer(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        confirmOwnershipTransfer(overrides?: Overrides & {
