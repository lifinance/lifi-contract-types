...
export interface GasZipInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ZERO" | "allowToken" | "allowedInboundTokens" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "gasZipRouter" | "owner" | "pendingOwner" | "transferOwnership" | "zip" | "zipERC20"): FunctionFragment;
