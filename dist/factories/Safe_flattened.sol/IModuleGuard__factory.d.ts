...
import type { IModuleGuard, IModuleGuardInterface } from "../../Safe_flattened.sol/IModuleGuard";
export declare class IModuleGuard__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IModuleGuard;
}
