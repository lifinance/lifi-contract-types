...
import type { IModuleManager, IModuleManagerInterface } from "../../Safe_flattened.sol/IModuleManager";
export declare class IModuleManager__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IModuleManager;
}
