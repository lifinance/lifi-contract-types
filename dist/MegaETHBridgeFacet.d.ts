...
export interface MegaETHBridgeFacet extends BaseContract {
    ...
    functions: {
        initMegaETH(configs: MegaETHBridgeFacet.ConfigStruct[], standardBridge: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        initMegaETH(configs: MegaETHBridgeFacet.ConfigStruct[], standardBridge: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
