...
export interface MegaETHBridgeFacet extends BaseContract {
    ...
    functions: {
        initMegaETH(_configs: MegaETHBridgeFacet.ConfigStruct[], _standardBridge: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        registerMegaETHBridge(assetId: PromiseOrValue<string>, bridge: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        initMegaETH(_configs: MegaETHBridgeFacet.ConfigStruct[], _standardBridge: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        registerMegaETHBridge(assetId: PromiseOrValue<string>, bridge: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
