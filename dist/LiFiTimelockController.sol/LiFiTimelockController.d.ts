...
export declare type DiamondAddressUpdatedEvent = TypedEvent<[
    string
], DiamondAddressUpdatedEventObject>;
export declare type DiamondAddressUpdatedEventFilter = TypedEventFilter<DiamondAddressUpdatedEvent>;
