...
export interface LiFiTimelockControllerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "unpauseDiamond", values: [PromiseOrValue<string>, PromiseOrValue<string>[]]): string;
...
export interface LiFiTimelockController extends BaseContract {
    ...
    functions: {
        ...
        unpauseDiamond(_diamond: PromiseOrValue<string>, _blacklist: PromiseOrValue<string>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        supportsInterface(interfaceId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        unpauseDiamond(_diamond: PromiseOrValue<string>, _blacklist: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
