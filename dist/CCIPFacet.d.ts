...
export declare namespace CCIPFacet {
    ...
    type CCIPDataStructOutput = [string, string, string] & {
        callData: string;
        extraArgs: string;
        receiver: string;
    };
...
export interface CCIPFacetInterface extends utils.Interface {
    functions: {
        "encodeDestinationArgs(uint256,bool)": FunctionFragment;
        "initCCIP((uint256,uint64)[])": FunctionFragment;
        "quoteCCIPFee((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes,bytes,address))": FunctionFragment;
        "routerClient()": FunctionFragment;
        "setCCIPChainSelector(uint256,uint64)": FunctionFragment;
        "startBridgeTokensViaCCIP((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes,bytes,address))": FunctionFragment;
        "swapAndStartBridgeTokensViaCCIP((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes,bytes,address))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "encodeDestinationArgs" | "initCCIP" | "quoteCCIPFee" | "routerClient" | "setCCIPChainSelector" | "startBridgeTokensViaCCIP" | "swapAndStartBridgeTokensViaCCIP"): FunctionFragment;
    encodeFunctionData(functionFragment: "encodeDestinationArgs", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "initCCIP", values: [CCIPFacet.ChainSelectorStruct[]]): string;
    encodeFunctionData(functionFragment: "quoteCCIPFee", values: [ILiFi.BridgeDataStruct, CCIPFacet.CCIPDataStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "encodeDestinationArgs", data: BytesLike): Result;
...
export interface CCIPFacet extends BaseContract {
    ...
    functions: {
        encodeDestinationArgs(gasLimit: PromiseOrValue<BigNumberish>, strictSequencing: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[string]>;
        initCCIP(chainSelectors: CCIPFacet.ChainSelectorStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        quoteCCIPFee(_bridgeData: ILiFi.BridgeDataStruct, _ccipData: CCIPFacet.CCIPDataStruct, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    estimateGas: {
        encodeDestinationArgs(gasLimit: PromiseOrValue<BigNumberish>, strictSequencing: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        initCCIP(chainSelectors: CCIPFacet.ChainSelectorStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        quoteCCIPFee(_bridgeData: ILiFi.BridgeDataStruct, _ccipData: CCIPFacet.CCIPDataStruct, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        encodeDestinationArgs(gasLimit: PromiseOrValue<BigNumberish>, strictSequencing: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initCCIP(chainSelectors: CCIPFacet.ChainSelectorStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        quoteCCIPFee(_bridgeData: ILiFi.BridgeDataStruct, _ccipData: CCIPFacet.CCIPDataStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
