...
export interface Permit2Proxy extends BaseContract {
    ...
    functions: {
        ...
        gaslessWitnessDiamondCallMultipleTokens(permit: ISignatureTransfer.PermitBatchTransferFromStruct, amounts: PromiseOrValue<BigNumberish>[], witnessData: PromiseOrValue<BytesLike>, senderAddress: PromiseOrValue<string>, signature: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        gaslessWitnessDiamondCallSingleToken(permit: ISignatureTransfer.PermitTransferFromStruct, amount: PromiseOrValue<BigNumberish>, witnessData: PromiseOrValue<BytesLike>, senderAddress: PromiseOrValue<string>, signature: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        diamondWhitelist(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        gaslessWitnessDiamondCallMultipleTokens(permit: ISignatureTransfer.PermitBatchTransferFromStruct, amounts: PromiseOrValue<BigNumberish>[], witnessData: PromiseOrValue<BytesLike>, senderAddress: PromiseOrValue<string>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        gaslessWitnessDiamondCallSingleToken(permit: ISignatureTransfer.PermitTransferFromStruct, amount: PromiseOrValue<BigNumberish>, witnessData: PromiseOrValue<BytesLike>, senderAddress: PromiseOrValue<string>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
        pendingOwner(overrides?: CallOverrides): Promise<string>;
        permit2(overrides?: CallOverrides): Promise<string>;
