...
export interface TestGetGasFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaGetGas" | "swapAndStartBridgeTokensViaGetGas"): FunctionFragment;
...
export interface TestGetGasFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestGetGasFacetInterface;
