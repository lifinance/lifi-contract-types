...
export interface LDADiamondCutFacetInterface extends utils.Interface {
    functions: {
...
export interface LDADiamondCutFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LDADiamondCutFacetInterface;
