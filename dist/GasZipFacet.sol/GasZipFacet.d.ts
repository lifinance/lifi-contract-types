...
export declare namespace GasZipFacet {
    type GasZipDataStruct = {
        gasZipChainId: PromiseOrValue<BigNumberish>;
...
export interface GasZipFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaGasZip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint256,(address,address,address,address,uint256,bytes,bool)))": FunctionFragment;
        "swapAndStartBridgeTokensViaGasZip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint256,(address,address,address,address,uint256,bytes,bool)))": FunctionFragment;
    };
...
export interface GasZipFacet extends BaseContract {
    ...
    functions: {
        depositToGasZipERC20(_swapData: LibSwap.SwapDataStruct, _destinationChains: PromiseOrValue<BigNumberish>, _recipient: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        depositToGasZipERC20(_swapData: LibSwap.SwapDataStruct, _destinationChains: PromiseOrValue<BigNumberish>, _recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
