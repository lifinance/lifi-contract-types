...
export declare namespace GlacisFacet {
    type GlacisDataStruct = {
        refund: PromiseOrValue<string>;
    };
    type GlacisDataStructOutput = [string] & {
        refund: string;
    };
}
...
export interface GlacisFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaGlacis((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address))": FunctionFragment;
        "swapAndStartBridgeTokensViaGlacis((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address))": FunctionFragment;
    };
