...
interface WithdrawFacetInterface extends ethers.utils.Interface {
  functions: {
...
export class WithdrawFacet extends BaseContract {
  ...
  filters: {
    "LogWithdraw(address,address,uint256)"(
      ...
      [string, string, BigNumber],
      { _assetAddress: string; _from: string; amount: BigNumber }
    >;
