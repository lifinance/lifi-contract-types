...
export interface UniV3StyleFacet extends BaseContract {
    ...
    callStatic: {
        ...
        swapUniV3(swapData: PromiseOrValue<BytesLike>, from: PromiseOrValue<string>, tokenIn: PromiseOrValue<string>, amountIn: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
