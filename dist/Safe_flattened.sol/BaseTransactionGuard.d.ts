...
export interface BaseTransactionGuardInterface extends utils.Interface {
    functions: {
...
export interface BaseTransactionGuard extends BaseContract {
    ...
    functions: {
        checkAfterExecution(hash: PromiseOrValue<BytesLike>, success: PromiseOrValue<boolean>, overrides?: Overrides & {
    ...
    supportsInterface(interfaceId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        checkAfterExecution(hash: PromiseOrValue<BytesLike>, success: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
