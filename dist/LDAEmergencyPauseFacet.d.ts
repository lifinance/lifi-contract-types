...
export interface LDAEmergencyPauseFacetInterface extends utils.Interface {
    functions: {
...
export interface LDAEmergencyPauseFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LDAEmergencyPauseFacetInterface;
