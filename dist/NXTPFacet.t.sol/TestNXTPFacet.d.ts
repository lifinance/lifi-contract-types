...
export interface TestNXTPFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaNXTP" | "swapAndStartBridgeTokensViaNXTP"): FunctionFragment;
...
export interface TestNXTPFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestNXTPFacetInterface;
