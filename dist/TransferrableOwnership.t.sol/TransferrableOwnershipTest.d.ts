...
export interface TransferrableOwnershipTestInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "testFailNonOwnerCanTransferOwnership" | "testFailOnwershipTransferToNullAddr" | "testFailOwnerCanConfirmPendingOwnershipTransfer" | "testFailOwnershipTransferToSelf" | "testOwnerCanTransferOwnership"): FunctionFragment;
...
export interface TransferrableOwnershipTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TransferrableOwnershipTestInterface;
