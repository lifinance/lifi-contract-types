...
export interface AcrossFacetV3Interface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaAcrossV3((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,uint256,uint32,uint32,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaAcrossV3((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,address,address,uint256,uint32,uint32,bytes))": FunctionFragment;
