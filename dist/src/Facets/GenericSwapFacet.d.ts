...
export interface GenericSwapFacetInterface extends utils.Interface {
    functions: {
        "swapTokensGeneric((bytes32,string,address,address,address,address,uint256,uint256),(address,address,address,address,uint256,bytes)[])": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "swapTokensGeneric"): FunctionFragment;
    encodeFunctionData(functionFragment: "swapTokensGeneric", values: [ILiFi.LiFiDataStruct, LibSwap.SwapDataStruct[]]): string;
    decodeFunctionResult(functionFragment: "swapTokensGeneric", data: BytesLike): Result;
    events: {
        "LiFiSwappedGeneric(bytes32,string,address,address,address,uint256,uint256)": EventFragment;
...
export interface GenericSwapFacet extends BaseContract {
    ...
    functions: {
        swapTokensGeneric(_lifiData: ILiFi.LiFiDataStruct, _swapData: LibSwap.SwapDataStruct[], overrides?: PayableOverrides & {
    ...
    callStatic: {
        swapTokensGeneric(_lifiData: ILiFi.LiFiDataStruct, _swapData: LibSwap.SwapDataStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "LiFiSwappedGeneric(bytes32,string,address,address,address,uint256,uint256)"(transactionId?: BytesLike | null, integrator?: null, referrer?: null, fromAssetId?: null, toAssetId?: null, fromAmount?: null, toAmount?: null): LiFiSwappedGenericEventFilter;
