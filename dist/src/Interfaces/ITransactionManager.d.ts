...
export interface ITransactionManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addAssetId" | "addLiquidity" | "addLiquidityFor" | "addRouter" | "cancel" | "fulfill" | "getChainId" | "getStoredChainId" | "prepare" | "removeAssetId" | "removeLiquidity" | "removeRouter"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "cancel", values: [ITransactionManager.CancelArgsStruct]): string;
    encodeFunctionData(functionFragment: "fulfill", values: [ITransactionManager.FulfillArgsStruct]): string;
...
export declare type AssetAddedEvent = TypedEvent<[
    string,
    string
], AssetAddedEventObject>;
export declare type AssetAddedEventFilter = TypedEventFilter<AssetAddedEvent>;
...
export declare type RouterAddedEvent = TypedEvent<[
    string,
    string
], RouterAddedEventObject>;
export declare type RouterAddedEventFilter = TypedEventFilter<RouterAddedEvent>;
export interface RouterRemovedEventObject {
    removedRouter: string;
    caller: string;
}
export declare type RouterRemovedEvent = TypedEvent<[
    string,
    string
], RouterRemovedEventObject>;
export declare type RouterRemovedEventFilter = TypedEventFilter<RouterRemovedEvent>;
...
export declare type TransactionCancelledEvent = TypedEvent<[
    ...
    string,
    string,
    ITransactionManager.CancelArgsStructOutput,
    string
...
export declare type TransactionFulfilledEvent = TypedEvent<[
    string,
    string,
    string,
...
export declare type TransactionFulfilledEventFilter = TypedEventFilter<TransactionFulfilledEvent>;
...
export declare type TransactionPreparedEvent = TypedEvent<[
    string,
    string,
    string,
    ITransactionManager.TransactionDataStructOutput,
...
export declare type TransactionPreparedEventFilter = TypedEventFilter<TransactionPreparedEvent>;
export interface ITransactionManager extends BaseContract {
    ...
    functions: {
        addAssetId(assetId: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addLiquidity(amount: BigNumberish, assetId: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addLiquidityFor(amount: BigNumberish, assetId: string, router: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addRouter(router: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        cancel(args: ITransactionManager.CancelArgsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        fulfill(args: ITransactionManager.FulfillArgsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        removeAssetId(assetId: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeLiquidity(amount: BigNumberish, assetId: string, recipient: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        cancel(args: ITransactionManager.CancelArgsStruct, overrides?: CallOverrides): Promise<ITransactionManager.TransactionDataStructOutput>;
        fulfill(args: ITransactionManager.FulfillArgsStruct, overrides?: CallOverrides): Promise<ITransactionManager.TransactionDataStructOutput>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getStoredChainId(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "AssetAdded(address,address)"(addedAssetId?: string | null, caller?: string | null): AssetAddedEventFilter;
        AssetAdded(addedAssetId?: string | null, caller?: string | null): AssetAddedEventFilter;
        "AssetRemoved(address,address)"(removedAssetId?: string | null, caller?: string | null): AssetRemovedEventFilter;
        AssetRemoved(removedAssetId?: string | null, caller?: string | null): AssetRemovedEventFilter;
        "LiquidityAdded(address,address,uint256,address)"(router?: string | null, assetId?: string | null, amount?: null, caller?: null): LiquidityAddedEventFilter;
        LiquidityAdded(router?: string | null, assetId?: string | null, amount?: null, caller?: null): LiquidityAddedEventFilter;
        "LiquidityRemoved(address,address,uint256,address)"(router?: string | null, assetId?: string | null, amount?: null, recipient?: null): LiquidityRemovedEventFilter;
        LiquidityRemoved(router?: string | null, assetId?: string | null, amount?: null, recipient?: null): LiquidityRemovedEventFilter;
        "RouterAdded(address,address)"(addedRouter?: string | null, caller?: string | null): RouterAddedEventFilter;
        RouterAdded(addedRouter?: string | null, caller?: string | null): RouterAddedEventFilter;
        "RouterRemoved(address,address)"(removedRouter?: string | null, caller?: string | null): RouterRemovedEventFilter;
        RouterRemoved(removedRouter?: string | null, caller?: string | null): RouterRemovedEventFilter;
        "TransactionCancelled(address,address,bytes32,tuple,address)"(user?: string | null, router?: string | null, transactionId?: BytesLike | null, args?: null, caller?: null): TransactionCancelledEventFilter;
        TransactionCancelled(user?: string | null, router?: string | null, transactionId?: BytesLike | null, args?: null, caller?: null): TransactionCancelledEventFilter;
        "TransactionFulfilled(address,address,bytes32,tuple,bool,bool,bytes,address)"(user?: string | null, router?: string | null, transactionId?: BytesLike | null, args?: null, success?: null, isContract?: null, returnData?: null, caller?: null): TransactionFulfilledEventFilter;
        TransactionFulfilled(user?: string | null, router?: string | null, transactionId?: BytesLike | null, args?: null, success?: null, isContract?: null, returnData?: null, caller?: null): TransactionFulfilledEventFilter;
        "TransactionPrepared(address,address,bytes32,tuple,address,tuple)"(user?: string | null, router?: string | null, transactionId?: BytesLike | null, txData?: null, caller?: null, args?: null): TransactionPreparedEventFilter;
        TransactionPrepared(user?: string | null, router?: string | null, transactionId?: BytesLike | null, txData?: null, caller?: null, args?: null): TransactionPreparedEventFilter;
    };
    estimateGas: {
        addAssetId(assetId: string, overrides?: Overrides & {
            from?: string | Promise<string>;
