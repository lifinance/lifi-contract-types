...
export interface ContractOneAuditInterface extends utils.Interface {
    functions: {
...
export interface ContractOneAudit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ContractOneAuditInterface;
