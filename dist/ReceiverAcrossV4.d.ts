...
export interface ReceiverAcrossV4Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "EXECUTOR" | "SPOKEPOOL" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "handleV3AcrossMessage" | "owner" | "pendingOwner" | "transferOwnership" | "withdrawToken"): FunctionFragment;
