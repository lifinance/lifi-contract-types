...
export interface SquidFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "squidRouter" | "startBridgeTokensViaSquid" | "swapAndStartBridgeTokensViaSquid"): FunctionFragment;
    encodeFunctionData(functionFragment: "squidRouter", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "squidRouter", data: BytesLike): Result;
...
export interface SquidFacet extends BaseContract {
    ...
    functions: {
        squidRouter(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        squidRouter(overrides?: CallOverrides): Promise<BigNumber>;
        startBridgeTokensViaSquid(_bridgeData: ILiFi.BridgeDataStruct, _squidData: SquidFacet.SquidDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        swapAndStartBridgeTokensViaSquid(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _squidData: SquidFacet.SquidDataStruct, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        squidRouter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaSquid(_bridgeData: ILiFi.BridgeDataStruct, _squidData: SquidFacet.SquidDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
