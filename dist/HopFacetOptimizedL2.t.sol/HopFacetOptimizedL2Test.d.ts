...
export interface HopFacetOptimizedL2TestInterface extends utils.Interface {
    functions: {
...
export interface HopFacetOptimizedL2Test extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HopFacetOptimizedL2TestInterface;
