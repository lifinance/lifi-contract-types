...
export interface IntentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "amoutOutMin" | "execute" | "executed" | "factory" | "implementation" | "init" | "intentId" | "receiver" | "salt" | "tokenOut" | "withdrawAll"): FunctionFragment;
    encodeFunctionData(functionFragment: "amoutOutMin", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "amoutOutMin", data: BytesLike): Result;
...
export interface Intent extends BaseContract {
    ...
    functions: {
        amoutOutMin(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        amoutOutMin(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        execute(calls: IIntent.CallStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
