...
export declare type CBridgeRefundEvent = TypedEvent<[
    string,
    string,
    BigNumber
], CBridgeRefundEventObject>;
export declare type CBridgeRefundEventFilter = TypedEventFilter<CBridgeRefundEvent>;
export interface LiFiCBridgeTransferEventObject {
    _transactionId: string;
}
export declare type LiFiCBridgeTransferEvent = TypedEvent<[
    string
], LiFiCBridgeTransferEventObject>;
export declare type LiFiCBridgeTransferEventFilter = TypedEventFilter<LiFiCBridgeTransferEvent>;
