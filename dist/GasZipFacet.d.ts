...
export interface GasZipFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaGasZip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint256,address))": FunctionFragment;
        "swapAndStartBridgeTokensViaGasZip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint256,address))": FunctionFragment;
    };
