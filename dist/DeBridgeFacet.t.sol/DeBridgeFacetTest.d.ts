...
export interface DeBridgeFacetTestInterface extends utils.Interface {
    functions: {
    ...
    decodeFunctionResult(functionFragment: "REVERT_IF_EXTERNAL_FAIL", data: BytesLike): Result;
...
export interface DeBridgeFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DeBridgeFacetTestInterface;
    ...
    populateTransaction: {
        ...
        REVERT_IF_EXTERNAL_FAIL(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        createUsers(userNum: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
