...
export interface ILiFiVaultWrapperFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "feeBounds"): FunctionFragment;
...
export interface ILiFiVaultWrapperFactory extends BaseContract {
    ...
    functions: {
        feeBounds(_feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[number, number] & {
            minBps: number;
            maxBps: number;
        }>;
    };
    ...
    estimateGas: {
        feeBounds(_feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        feeBounds(_feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
