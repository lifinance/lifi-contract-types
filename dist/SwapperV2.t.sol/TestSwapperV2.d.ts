...
export interface TestSwapperV2Interface extends utils.Interface {
    functions: {
        "addDex(address)": FunctionFragment;
        "doSwaps((address,address,address,address,uint256,bytes,bool)[])": FunctionFragment;
        "setFunctionApprovalBySignature(bytes4)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "addDex" | "doSwaps" | "setFunctionApprovalBySignature"): FunctionFragment;
    encodeFunctionData(functionFragment: "addDex", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "doSwaps", values: [LibSwap.SwapDataStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "doSwaps", data: BytesLike): Result;
...
export interface TestSwapperV2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestSwapperV2Interface;
    ...
    functions: {
        ...
        doSwaps(_swapData: LibSwap.SwapDataStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        doSwaps(_swapData: LibSwap.SwapDataStruct[], overrides?: CallOverrides): Promise<void>;
