...
export declare namespace CelerCircleBridgeV2Facet {
    type CelerCircleBridgeDataStruct = {
        maxFee: PromiseOrValue<BigNumberish>;
        minFinalityThreshold: PromiseOrValue<BigNumberish>;
    };
    type CelerCircleBridgeDataStructOutput = [BigNumber, number] & {
        maxFee: BigNumber;
...
export interface CelerCircleBridgeV2FacetInterface extends utils.Interface {
    functions: {
        "CIRCLE_BRIDGE_PROXY_V2()": FunctionFragment;
        "USDC()": FunctionFragment;
        "startBridgeTokensViaCelerCircleBridgeV2((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint256,uint32))": FunctionFragment;
        "swapAndStartBridgeTokensViaCelerCircleBridgeV2((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint256,uint32))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "CIRCLE_BRIDGE_PROXY_V2" | "USDC" | "startBridgeTokensViaCelerCircleBridgeV2" | "swapAndStartBridgeTokensViaCelerCircleBridgeV2"): FunctionFragment;
    encodeFunctionData(functionFragment: "CIRCLE_BRIDGE_PROXY_V2", values?: undefined): string;
    encodeFunctionData(functionFragment: "USDC", values?: undefined): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaCelerCircleBridgeV2", values: [
        ILiFi.BridgeDataStruct,
        CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct
    ]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaCelerCircleBridgeV2", values: [
        ILiFi.BridgeDataStruct,
        LibSwap.SwapDataStruct[],
        CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct
    ]): string;
    decodeFunctionResult(functionFragment: "CIRCLE_BRIDGE_PROXY_V2", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "USDC", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "startBridgeTokensViaCelerCircleBridgeV2", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapAndStartBridgeTokensViaCelerCircleBridgeV2", data: BytesLike): Result;
    events: {
...
export interface CelerCircleBridgeV2Facet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CelerCircleBridgeV2FacetInterface;
    ...
    functions: {
        CIRCLE_BRIDGE_PROXY_V2(overrides?: CallOverrides): Promise<[string]>;
        USDC(overrides?: CallOverrides): Promise<[string]>;
        startBridgeTokensViaCelerCircleBridgeV2(_bridgeData: ILiFi.BridgeDataStruct, _celerCircleBridgeData: CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaCelerCircleBridgeV2(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _celerCircleBridgeData: CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    CIRCLE_BRIDGE_PROXY_V2(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        CIRCLE_BRIDGE_PROXY_V2(overrides?: CallOverrides): Promise<string>;
        USDC(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaCelerCircleBridgeV2(_bridgeData: ILiFi.BridgeDataStruct, _celerCircleBridgeData: CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaCelerCircleBridgeV2(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _celerCircleBridgeData: CelerCircleBridgeV2Facet.CelerCircleBridgeDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    estimateGas: {
        CIRCLE_BRIDGE_PROXY_V2(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        CIRCLE_BRIDGE_PROXY_V2(overrides?: CallOverrides): Promise<PopulatedTransaction>;
