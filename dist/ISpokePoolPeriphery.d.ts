...
export interface ISpokePoolPeripheryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "swapAndBridge", values: [ISpokePoolPeriphery.SwapAndDepositDataStruct]): string;
...
export interface ISpokePoolPeriphery extends BaseContract {
    ...
    functions: {
        swapAndBridge(swapAndDepositData: ISpokePoolPeriphery.SwapAndDepositDataStruct, overrides?: PayableOverrides & {
    ...
    callStatic: {
        swapAndBridge(swapAndDepositData: ISpokePoolPeriphery.SwapAndDepositDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        swapAndBridge(swapAndDepositData: ISpokePoolPeriphery.SwapAndDepositDataStruct, overrides?: PayableOverrides & {
