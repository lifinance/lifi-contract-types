...
export interface OpBNBBridgeFacetInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "startBridgeTokensViaOpBNBBridge", values: [ILiFi.BridgeDataStruct, OpBNBBridgeFacet.OptimismDataStruct]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaOpBNBBridge", values: [
        ILiFi.BridgeDataStruct,
        LibSwap.SwapDataStruct[],
        OpBNBBridgeFacet.OptimismDataStruct
    ]): string;
...
export interface OpBNBBridgeFacet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaOpBNBBridge(_bridgeData: ILiFi.BridgeDataStruct, _optimismData: OpBNBBridgeFacet.OptimismDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaOpBNBBridge(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _optimismData: OpBNBBridgeFacet.OptimismDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    initOpBNB(configs: OpBNBBridgeFacet.ConfigStruct[], standardBridge: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        startBridgeTokensViaOpBNBBridge(_bridgeData: ILiFi.BridgeDataStruct, _optimismData: OpBNBBridgeFacet.OptimismDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaOpBNBBridge(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _optimismData: OpBNBBridgeFacet.OptimismDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
