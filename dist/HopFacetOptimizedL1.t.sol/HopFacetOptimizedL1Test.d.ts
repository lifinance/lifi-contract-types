...
export interface HopFacetOptimizedL1TestInterface extends utils.Interface {
    functions: {
...
export interface HopFacetOptimizedL1Test extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HopFacetOptimizedL1TestInterface;
