...
export interface LiFiVaultWrapperFactoryInterface extends utils.Interface {
    functions: {
        ...
        "deploy((bytes32,address,address,address,uint256,(uint16[4],bool[4]),uint16,bytes))": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "allowedUnderlying" | "approvedAdapter" | "approvedIntegratorDeployer" | "beacon" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "defaultIntegratorShareBps" | "deploy" | "emergencyPauser" | "feeBounds" | "globalPause" | "globalPaused" | "globalUnpause" | "instanceBySalt" | "isInstance" | "onboardingManager" | "owner" | "pendingOwner" | "predictAddress" | "setAdapterApproved" | "setApprovedIntegratorDeployer" | "setDefaultSplit" | "setEmergencyPauser" | "setFeeBounds" | "setOnboardingManager" | "setUnderlyingAllowed" | "transferOwnership"): FunctionFragment;
