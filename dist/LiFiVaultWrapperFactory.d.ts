...
export interface LiFiVaultWrapperFactory extends BaseContract {
    ...
    functions: {
        ...
        initialize(_beacon: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _emergencyPauser: PromiseOrValue<string>, _onboardingManager: PromiseOrValue<string>, _lifiFeeRecipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_beacon: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _emergencyPauser: PromiseOrValue<string>, _onboardingManager: PromiseOrValue<string>, _lifiFeeRecipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        isInstance(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        lifiFeeRecipient(overrides?: CallOverrides): Promise<string>;
        onboardingManager(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
