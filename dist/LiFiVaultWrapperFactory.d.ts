...
export type FeeBoundsStruct = {
    minBps: PromiseOrValue<BigNumberish>;
    maxBps: PromiseOrValue<BigNumberish>;
};
export type FeeBoundsStructOutput = [number, number] & {
    minBps: number;
    maxBps: number;
};
export type FactoryInitParamsStruct = {
    beacon: PromiseOrValue<string>;
    owner: PromiseOrValue<string>;
    emergencyPauser: PromiseOrValue<string>;
    onboardingManager: PromiseOrValue<string>;
    lifiFeeRecipient: PromiseOrValue<string>;
    adapter: PromiseOrValue<string>;
    allowedUnderlyings: PromiseOrValue<string>[];
    feeBounds: [
        FeeBoundsStruct,
        FeeBoundsStruct,
        FeeBoundsStruct,
    ...
    defaultIntegratorShareBps: PromiseOrValue<BigNumberish>;
};
export type FactoryInitParamsStructOutput = [
    string,
    string,
    string,
    string,
    ...
    defaultIntegratorShareBps: number;
};
export interface LiFiVaultWrapperFactoryInterface extends utils.Interface {
    functions: {
        ...
        "initialize((address,address,address,address,address,address,address[],(uint16,uint16)[4],uint16))": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "acceptOwnership" | "allowedUnderlying" | "approvedAdapter" | "approvedIntegratorDeployer" | "beacon" | "defaultIntegratorShareBps" | "deploy" | "emergencyPauser" | "feeBounds" | "globalPause" | "globalPaused" | "globalUnpause" | "initialize" | "isInstance" | "lifiFeeRecipient" | "onboardingManager" | "owner" | "pendingOwner" | "predictAddress" | "renounceOwnership" | "setAdapterApproved" | "setApprovedIntegratorDeployer" | "setDefaultSplit" | "setEmergencyPauser" | "setFeeBounds" | "setLifiFeeRecipient" | "setOnboardingManager" | "setUnderlyingAllowed" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [FactoryInitParamsStruct]): string;
...
export interface LiFiVaultWrapperFactory extends BaseContract {
    ...
    functions: {
        ...
        initialize(_params: FactoryInitParamsStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_params: FactoryInitParamsStruct, overrides?: CallOverrides): Promise<void>;
        isInstance(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        lifiFeeRecipient(overrides?: CallOverrides): Promise<string>;
        onboardingManager(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
