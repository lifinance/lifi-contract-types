...
export declare namespace EverclearFacet {
    type EverclearDataStruct = {
        ...
        amountOutMinMultiplier: PromiseOrValue<BigNumberish>;
    ...
    type EverclearDataStructOutput = [
        ...
        amountOutMinMultiplier: BigNumber;
        ttl: number;
        data: string;
        fee: BigNumber;
        deadline: BigNumber;
...
export interface EverclearFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaEverclear((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,uint256,bytes32,uint256,uint128,uint48,bytes,uint256,uint256,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaEverclear((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,uint256,bytes32,uint256,uint128,uint48,bytes,uint256,uint256,bytes))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "FEE_ADAPTER" | "MULTIPLIER_BASE" | "startBridgeTokensViaEverclear" | "swapAndStartBridgeTokensViaEverclear"): FunctionFragment;
