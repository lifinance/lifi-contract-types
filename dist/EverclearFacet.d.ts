...
export declare namespace EverclearFacet {
    type EverclearDataStruct = {
        feeAdapter: PromiseOrValue<string>;
    };
    type EverclearDataStructOutput = [string] & {
        feeAdapter: string;
    };
}
...
export interface EverclearFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaEverclear((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(string))": FunctionFragment;
        "swapAndStartBridgeTokensViaEverclear((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(string))": FunctionFragment;
    };
