...
export interface TestPolygonBridgeFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaPolygonBridge" | "swapAndStartBridgeTokensViaPolygonBridge"): FunctionFragment;
...
export interface TestPolygonBridgeFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestPolygonBridgeFacetInterface;
