...
export interface PolygonBridgeFacetTestInterface extends utils.Interface {
    functions: {
...
export interface PolygonBridgeFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PolygonBridgeFacetTestInterface;
