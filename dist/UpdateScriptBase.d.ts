...
export interface UpdateScriptBaseInterface extends utils.Interface {
    functions: {
        "IS_SCRIPT()": FunctionFragment;
        "fromCode(bytes4)": FunctionFragment;
        "vm()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_SCRIPT" | "fromCode" | "vm"): FunctionFragment;
...
export interface UpdateScriptBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: UpdateScriptBaseInterface;
