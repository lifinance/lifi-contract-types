...
export declare namespace ChainflipFacet {
    type ChainflipDataStruct = {
        ...
        nonEvmAddress: PromiseOrValue<BytesLike>;
        cfParameters: PromiseOrValue<BytesLike>;
    };
    type ChainflipDataStructOutput = [number, string, string] & {
        dstToken: number;
...
export interface ChainflipFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaChainflip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint32,bytes32,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaChainflip((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint32,bytes32,bytes))": FunctionFragment;
    };
