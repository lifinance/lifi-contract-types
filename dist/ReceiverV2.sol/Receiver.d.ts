...
export interface ReceiverInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "amarokRouter" | "cancelIntent" | "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "executeIntent" | "owner" | "pendingOwner" | "refundExpiredIntent" | "sgReceive" | "sgRouter" | "swapIntents" | "transferOwnership" | "xReceive"): FunctionFragment;
