...
export interface TestBaseInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_SCRIPT" | "IS_TEST" | "createUsers" | "failed" | "getNextUserAddress" | "mineBlocks" | "vm"): FunctionFragment;
...
export interface TestBase extends BaseContract {
