...
export interface ILiFiVaultWrapperInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deposit" | "initialize" | "mint" | "redeem" | "withdraw"): FunctionFragment;
...
export type LifiPayoutRetainedEventFilter = TypedEventFilter<LifiPayoutRetainedEvent>;
...
export interface ILiFiVaultWrapper extends BaseContract {
    ...
    functions: {
        deposit(_assets: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _minShares: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
        ...
        mint(_shares: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _maxAssets: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        redeem(_shares: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _minAssets: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        withdraw(_assets: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _maxShares: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    deposit(_assets: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _minShares: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        deposit(_assets: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _minShares: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_underlying: PromiseOrValue<string>, _adapter: PromiseOrValue<string>, _vaultWrapperAdmin: PromiseOrValue<string>, _integratorShareBps: [
            PromiseOrValue<BigNumberish>,
            PromiseOrValue<BigNumberish>,
            PromiseOrValue<BigNumberish>,
        ...
        mint(_shares: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _maxAssets: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        redeem(_shares: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _minAssets: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        withdraw(_assets: PromiseOrValue<BigNumberish>, _receiver: PromiseOrValue<string>, _owner: PromiseOrValue<string>, _maxShares: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
        ...
        "LifiPayoutRetained(address,address,uint256)"(recipient?: PromiseOrValue<string> | null, token?: PromiseOrValue<string> | null, amount?: null): LifiPayoutRetainedEventFilter;
        LifiPayoutRetained(recipient?: PromiseOrValue<string> | null, token?: PromiseOrValue<string> | null, amount?: null): LifiPayoutRetainedEventFilter;
