...
export interface CelerIMFacetImmutableInterface extends utils.Interface {
    functions: {
...
export interface CelerIMFacetImmutable extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CelerIMFacetImmutableInterface;
