...
export interface ContractThreeTestInterface extends utils.Interface {
    functions: {
        "deposit(address,uint256)": FunctionFragment;
        "swap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "deposit" | "swap"): FunctionFragment;
    encodeFunctionData(functionFragment: "deposit", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "swap", values: [ILiFi.BridgeDataStruct, LibSwap.SwapDataStruct]): string;
...
export interface ContractThreeTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ContractThreeTestInterface;
    ...
    functions: {
        ...
        swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    deposit(token: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
