...
export interface RelayerCelerIMTestInterface extends utils.Interface {
    functions: {
...
export interface RelayerCelerIMTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RelayerCelerIMTestInterface;
