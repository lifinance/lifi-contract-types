...
export interface CBridgeRefundTestPolygonInterface extends utils.Interface {
    functions: {
        "IS_TEST()": FunctionFragment;
        "failed()": FunctionFragment;
        "initCallData()": FunctionFragment;
        "setUp()": FunctionFragment;
        "testCanExecuteCallAndWithdraw()": FunctionFragment;
        "testFailExecuteCallAndWithdraw()": FunctionFragment;
        "testFailExecuteCallAndWithdrawFromNonOwner()": FunctionFragment;
        "testFailExecuteCallAndWithdrawMultiple()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "failed" | "initCallData" | "setUp" | "testCanExecuteCallAndWithdraw" | "testFailExecuteCallAndWithdraw" | "testFailExecuteCallAndWithdrawFromNonOwner" | "testFailExecuteCallAndWithdrawMultiple"): FunctionFragment;
    encodeFunctionData(functionFragment: "IS_TEST", values?: undefined): string;
    encodeFunctionData(functionFragment: "failed", values?: undefined): string;
    encodeFunctionData(functionFragment: "initCallData", values?: undefined): string;
    encodeFunctionData(functionFragment: "setUp", values?: undefined): string;
    encodeFunctionData(functionFragment: "testCanExecuteCallAndWithdraw", values?: undefined): string;
    encodeFunctionData(functionFragment: "testFailExecuteCallAndWithdraw", values?: undefined): string;
    encodeFunctionData(functionFragment: "testFailExecuteCallAndWithdrawFromNonOwner", values?: undefined): string;
    encodeFunctionData(functionFragment: "testFailExecuteCallAndWithdrawMultiple", values?: undefined): string;
    decodeFunctionResult(functionFragment: "IS_TEST", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "failed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initCallData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUp", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCanExecuteCallAndWithdraw", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testFailExecuteCallAndWithdraw", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testFailExecuteCallAndWithdrawFromNonOwner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testFailExecuteCallAndWithdrawMultiple", data: BytesLike): Result;
    events: {
...
export interface CBridgeRefundTestPolygon extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CBridgeRefundTestPolygonInterface;
    ...
    functions: {
        ...
        initCallData(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setUp(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCanExecuteCallAndWithdraw(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testFailExecuteCallAndWithdraw(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testFailExecuteCallAndWithdrawFromNonOwner(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testFailExecuteCallAndWithdrawMultiple(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        initCallData(overrides?: CallOverrides): Promise<void>;
        setUp(overrides?: CallOverrides): Promise<void>;
        testCanExecuteCallAndWithdraw(overrides?: CallOverrides): Promise<void>;
        testFailExecuteCallAndWithdraw(overrides?: CallOverrides): Promise<void>;
        testFailExecuteCallAndWithdrawFromNonOwner(overrides?: CallOverrides): Promise<void>;
        testFailExecuteCallAndWithdrawMultiple(overrides?: CallOverrides): Promise<void>;
    };
    filters: {
