...
export interface LiFiDEXAggregatorDiamondInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface LiFiDEXAggregatorDiamond extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LiFiDEXAggregatorDiamondInterface;
