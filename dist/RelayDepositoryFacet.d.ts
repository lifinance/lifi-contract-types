...
export interface RelayDepositoryFacetInterface extends utils.Interface {
    ...
    events: {
        ...
        "RelayDepositoryDeposit(bytes32,address)": EventFragment;
    };
    ...
    getEvent(nameOrSignatureOrTopic: "RelayDepositoryDeposit"): EventFragment;
}
...
export interface RelayDepositoryDepositEventObject {
    orderId: string;
    depository: string;
}
export type RelayDepositoryDepositEvent = TypedEvent<[
    string,
    string
], RelayDepositoryDepositEventObject>;
export type RelayDepositoryDepositEventFilter = TypedEventFilter<RelayDepositoryDepositEvent>;
export interface RelayDepositoryFacet extends BaseContract {
    ...
    filters: {
        ...
        "RelayDepositoryDeposit(bytes32,address)"(orderId?: PromiseOrValue<BytesLike> | null, depository?: PromiseOrValue<string> | null): RelayDepositoryDepositEventFilter;
        RelayDepositoryDeposit(orderId?: PromiseOrValue<BytesLike> | null, depository?: PromiseOrValue<string> | null): RelayDepositoryDepositEventFilter;
    };
    estimateGas: {
