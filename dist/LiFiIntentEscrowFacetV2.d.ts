...
export interface LiFiIntentEscrowFacetV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "LIFI_INTENT_ESCROW_SETTLER_V2" | "startBridgeTokensViaLiFiIntentEscrowV2" | "swapAndStartBridgeTokensViaLiFiIntentEscrowV2"): FunctionFragment;
    encodeFunctionData(functionFragment: "LIFI_INTENT_ESCROW_SETTLER_V2", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "LIFI_INTENT_ESCROW_SETTLER_V2", data: BytesLike): Result;
