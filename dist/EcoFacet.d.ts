...
export declare namespace EcoFacet {
    type EcoDataStruct = {
        intentSource: PromiseOrValue<string>;
        receiver: PromiseOrValue<string>;
...
export interface EcoFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,uint256,uint256,bytes,bool))": FunctionFragment;
        "swapAndStartBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,address,address,uint256,uint256,bytes,bool))": FunctionFragment;
    };
