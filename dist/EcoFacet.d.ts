...
export interface EcoFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,bytes,address,uint64,uint256,bytes,bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,bytes,address,uint64,uint256,bytes,bytes32))": FunctionFragment;
    };
