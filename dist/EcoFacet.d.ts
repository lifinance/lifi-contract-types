...
export declare namespace EcoFacet {
    type EcoDataStruct = {
        ...
        destinationInbox: PromiseOrValue<string>;
...
export interface EcoFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,bytes,address,bytes32,address,address,uint64,uint256,(address,bytes,uint256)[]))": FunctionFragment;
        "swapAndStartBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,bytes,address,bytes32,address,address,uint64,uint256,(address,bytes,uint256)[]))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "intentSource" | "startBridgeTokensViaEco" | "swapAndStartBridgeTokensViaEco"): FunctionFragment;
    encodeFunctionData(functionFragment: "intentSource", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "intentSource", data: BytesLike): Result;
...
export interface EcoFacet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaEco(_bridgeData: ILiFi.BridgeDataStruct, _ecoData: EcoFacet.EcoDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaEco(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _ecoData: EcoFacet.EcoDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    intentSource(overrides?: CallOverrides): Promise<string>;
