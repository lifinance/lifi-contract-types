...
export interface EcoFacetInterface extends utils.Interface {
    functions: {
        "DEFAULT_PROVER()": FunctionFragment;
        "startBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,uint64,uint64,bytes32,(address,bytes,uint256)[],bool))": FunctionFragment;
        "swapAndStartBridgeTokensViaEco((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,address,address,uint64,uint64,bytes32,(address,bytes,uint256)[],bool))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "DEFAULT_PROVER" | "startBridgeTokensViaEco" | "swapAndStartBridgeTokensViaEco"): FunctionFragment;
    encodeFunctionData(functionFragment: "DEFAULT_PROVER", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "DEFAULT_PROVER", data: BytesLike): Result;
...
export interface EcoFacet extends BaseContract {
    ...
    functions: {
        DEFAULT_PROVER(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        DEFAULT_PROVER(overrides?: CallOverrides): Promise<BigNumber>;
        startBridgeTokensViaEco(_bridgeData: ILiFi.BridgeDataStruct, _ecoData: EcoFacet.EcoDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        swapAndStartBridgeTokensViaEco(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _ecoData: EcoFacet.EcoDataStruct, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        DEFAULT_PROVER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaEco(_bridgeData: ILiFi.BridgeDataStruct, _ecoData: EcoFacet.EcoDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
