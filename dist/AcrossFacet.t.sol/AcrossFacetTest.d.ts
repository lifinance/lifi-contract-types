...
export interface AcrossFacetTestInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "testFailsToBridgeERC20TokensDueToQuoteTimeout", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testFailsToBridgeERC20TokensDueToQuoteTimeout", data: BytesLike): Result;
...
export interface AcrossFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AcrossFacetTestInterface;
    ...
    functions: {
        ...
        testFailsToBridgeERC20TokensDueToQuoteTimeout(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        testFailsToBridgeERC20TokensDueToQuoteTimeout(overrides?: CallOverrides): Promise<void>;
        vm(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
