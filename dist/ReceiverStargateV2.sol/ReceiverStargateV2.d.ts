...
export interface ReceiverStargateV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "cancelOwnershipTransfer" | "confirmOwnershipTransfer" | "endpointV2" | "executor" | "lzCompose" | "owner" | "pendingOwner" | "pullToken" | "recoverGas" | "transferOwnership"): FunctionFragment;
