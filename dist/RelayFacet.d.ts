...
export interface RelayFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "consumedIds" | "startBridgeTokensViaRelay" | "swapAndStartBridgeTokensViaRelay"): FunctionFragment;
...
export interface RelayFacet extends BaseContract {
    ...
    functions: {
        consumedIds(requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        consumedIds(requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        startBridgeTokensViaRelay(_bridgeData: ILiFi.BridgeDataStruct, _relayData: RelayFacet.RelayDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        swapAndStartBridgeTokensViaRelay(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _relayData: RelayFacet.RelayDataStruct, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        consumedIds(requestId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaRelay(_bridgeData: ILiFi.BridgeDataStruct, _relayData: RelayFacet.RelayDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
