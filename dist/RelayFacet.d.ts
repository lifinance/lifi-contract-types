...
export declare namespace RelayFacet {
    ...
    type RelayDataStructOutput = [string, string, string] & {
        requestId: string;
...
export interface RelayFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaRelay((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,address,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaRelay((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,address,bytes))": FunctionFragment;
    };
