...
export interface AcrossFacetPackedV3Interface extends utils.Interface {
    functions: {
        ...
        "encode_startBridgeTokensViaAcrossV3ERC20Packed(bytes32,address,uint256,address,uint64,address,uint256,uint32,uint32,bytes)": FunctionFragment;
        "encode_startBridgeTokensViaAcrossV3NativePacked(bytes32,address,uint256,address,uint256,uint32,uint32,bytes)": FunctionFragment;
        ...
        "startBridgeTokensViaAcrossV3ERC20Min(bytes32,address,uint256,address,uint64,address,uint256,uint32,uint32,bytes)": FunctionFragment;
        "startBridgeTokensViaAcrossV3ERC20Packed()": FunctionFragment;
        "startBridgeTokensViaAcrossV3NativeMin(bytes32,address,uint256,address,uint256,uint32,uint32,bytes)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "encode_startBridgeTokensViaAcrossV3NativePacked", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
    ...
    encodeFunctionData(functionFragment: "startBridgeTokensViaAcrossV3NativeMin", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
...
export interface AcrossFacetPackedV3 extends BaseContract {
    ...
    functions: {
        ...
        encode_startBridgeTokensViaAcrossV3ERC20Packed(transactionId: PromiseOrValue<BytesLike>, sendingAssetId: PromiseOrValue<string>, inputAmount: PromiseOrValue<BigNumberish>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
        encode_startBridgeTokensViaAcrossV3NativePacked(transactionId: PromiseOrValue<BytesLike>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
        ...
        startBridgeTokensViaAcrossV3ERC20Min(transactionId: PromiseOrValue<BytesLike>, sendingAssetId: PromiseOrValue<string>, inputAmount: PromiseOrValue<BigNumberish>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        startBridgeTokensViaAcrossV3ERC20Packed(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        startBridgeTokensViaAcrossV3NativeMin(transactionId: PromiseOrValue<BytesLike>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        spokePool(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaAcrossV3ERC20Min(transactionId: PromiseOrValue<BytesLike>, sendingAssetId: PromiseOrValue<string>, inputAmount: PromiseOrValue<BigNumberish>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        startBridgeTokensViaAcrossV3ERC20Packed(overrides?: CallOverrides): Promise<void>;
        startBridgeTokensViaAcrossV3NativeMin(transactionId: PromiseOrValue<BytesLike>, receiver: PromiseOrValue<string>, destinationChainId: PromiseOrValue<BigNumberish>, receivingAssetId: PromiseOrValue<string>, outputAmount: PromiseOrValue<BigNumberish>, quoteTimestamp: PromiseOrValue<BigNumberish>, fillDeadline: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
