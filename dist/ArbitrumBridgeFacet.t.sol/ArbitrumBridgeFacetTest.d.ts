...
export interface ArbitrumBridgeFacetTestInterface extends utils.Interface {
    functions: {
...
export interface ArbitrumBridgeFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ArbitrumBridgeFacetTestInterface;
