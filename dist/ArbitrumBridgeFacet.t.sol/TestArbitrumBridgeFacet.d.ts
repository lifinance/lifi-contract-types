...
export interface TestArbitrumBridgeFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaArbitrumBridge" | "swapAndStartBridgeTokensViaArbitrumBridge"): FunctionFragment;
...
export interface TestArbitrumBridgeFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestArbitrumBridgeFacetInterface;
