...
export interface TestGnosisBridgeFacetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDex" | "setFunctionApprovalBySignature" | "startBridgeTokensViaXDaiBridge" | "swapAndStartBridgeTokensViaXDaiBridge"): FunctionFragment;
...
export interface TestGnosisBridgeFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestGnosisBridgeFacetInterface;
