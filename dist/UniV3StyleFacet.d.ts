...
export interface UniV3StyleFacetInterface extends utils.Interface {
    functions: {
        ...
        "swapUniV3(uint256,address,address,uint256)": FunctionFragment;
...
export interface UniV3StyleFacet extends BaseContract {
    ...
    functions: {
        ...
        swapUniV3(stream: PromiseOrValue<BigNumberish>, from: PromiseOrValue<string>, tokenIn: PromiseOrValue<string>, amountIn: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        swapUniV3(stream: PromiseOrValue<BigNumberish>, from: PromiseOrValue<string>, tokenIn: PromiseOrValue<string>, amountIn: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
