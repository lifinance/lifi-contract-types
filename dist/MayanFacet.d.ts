...
export interface MayanFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "initMayan" | "mayanBridge" | "setMayanChainIdMapping" | "startBridgeTokensViaMayan" | "swapAndStartBridgeTokensViaMayan"): FunctionFragment;
...
export interface MayanFacet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaMayan(_bridgeData: ILiFi.BridgeDataStruct, _mayanBridgeData: MayanFacet.MayanDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaMayan(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _mayanBridgeData: MayanFacet.MayanDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    initMayan(configs: MayanFacet.ConfigStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        startBridgeTokensViaMayan(_bridgeData: ILiFi.BridgeDataStruct, _mayanBridgeData: MayanFacet.MayanDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaMayan(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _mayanBridgeData: MayanFacet.MayanDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
