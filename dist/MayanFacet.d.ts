...
export interface MayanFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaMayan((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,bytes,bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaMayan((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,bytes,bytes32))": FunctionFragment;
    };
