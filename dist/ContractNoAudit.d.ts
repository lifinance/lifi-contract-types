...
export interface ContractNoAuditInterface extends utils.Interface {
    functions: {
...
export interface ContractNoAudit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ContractNoAuditInterface;
