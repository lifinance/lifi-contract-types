...
export interface IWhitelistManagerFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getWhitelistedAddresses" | "getWhitelistedFunctionSelectors" | "isAddressWhitelisted" | "isFunctionSelectorWhitelisted" | "isMigrated" | "migrate" | "setContractSelectorWhitelist"): FunctionFragment;
