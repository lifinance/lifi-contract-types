...
export interface IOftERC4626Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "exchangeRate" | "transferShares"): FunctionFragment;
...
export interface IOftERC4626 extends BaseContract {
    ...
    functions: {
        ...
        transferShares(to: PromiseOrValue<string>, shares: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        exchangeRate(overrides?: CallOverrides): Promise<BigNumber>;
        transferShares(to: PromiseOrValue<string>, shares: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        exchangeRate(overrides?: CallOverrides): Promise<BigNumber>;
