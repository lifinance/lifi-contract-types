...
export interface IGasZip extends BaseContract {
    ...
    functions: {
        deposit(chains: PromiseOrValue<BigNumberish>, to: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
    ...
    callStatic: {
        deposit(chains: PromiseOrValue<BigNumberish>, to: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        deposit(chains: PromiseOrValue<BigNumberish>, to: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
