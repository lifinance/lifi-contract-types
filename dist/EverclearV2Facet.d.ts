...
export interface EverclearV2FacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "FEE_ADAPTER_V2" | "startBridgeTokensViaEverclear" | "swapAndStartBridgeTokensViaEverclear"): FunctionFragment;
    encodeFunctionData(functionFragment: "FEE_ADAPTER_V2", values?: undefined): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaEverclear", values: [ILiFi.BridgeDataStruct, EverclearV2Facet.EverclearDataStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "FEE_ADAPTER_V2", data: BytesLike): Result;
...
export interface EverclearV2Facet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaEverclear(_bridgeData: ILiFi.BridgeDataStruct, _everclearData: EverclearV2Facet.EverclearDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaEverclear(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _everclearData: EverclearV2Facet.EverclearDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    FEE_ADAPTER_V2(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        FEE_ADAPTER_V2(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaEverclear(_bridgeData: ILiFi.BridgeDataStruct, _everclearData: EverclearV2Facet.EverclearDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaEverclear(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _everclearData: EverclearV2Facet.EverclearDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
