...
export interface OutputValidatorInterface extends utils.Interface {
    ...
    events: {
        "OutputValidated(address,address,uint256)": EventFragment;
        "OwnershipTransferRequested(address,address)": EventFragment;
        "OwnershipTransferred(address,address)": EventFragment;
        "TokensWithdrawn(address,address,uint256)": EventFragment;
    };
    getEvent(nameOrSignatureOrTopic: "OutputValidated"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferRequested"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "TokensWithdrawn"): EventFragment;
}
export interface OutputValidatedEventObject {
    token: string;
    validationWallet: string;
    excessAmount: BigNumber;
}
export type OutputValidatedEvent = TypedEvent<[
    string,
    string,
    BigNumber
], OutputValidatedEventObject>;
export type OutputValidatedEventFilter = TypedEventFilter<OutputValidatedEvent>;
...
export interface OutputValidator extends BaseContract {
    ...
    filters: {
        "OutputValidated(address,address,uint256)"(token?: PromiseOrValue<string> | null, validationWallet?: PromiseOrValue<string> | null, excessAmount?: null): OutputValidatedEventFilter;
        OutputValidated(token?: PromiseOrValue<string> | null, validationWallet?: PromiseOrValue<string> | null, excessAmount?: null): OutputValidatedEventFilter;
