...
export declare namespace UnitFacet {
    ...
    type UnitDataStructOutput = [string, string] & {
...
export interface UnitFacetInterface extends utils.Interface {
    functions: {
        "initUnit(bytes,bytes,bytes)": FunctionFragment;
        "startBridgeTokensViaUnit((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaUnit((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,bytes))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "initUnit" | "startBridgeTokensViaUnit" | "swapAndStartBridgeTokensViaUnit"): FunctionFragment;
    encodeFunctionData(functionFragment: "initUnit", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>
    ]): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaUnit", values: [ILiFi.BridgeDataStruct, UnitFacet.UnitDataStruct]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaUnit", values: [
        ILiFi.BridgeDataStruct,
        LibSwap.SwapDataStruct[],
        UnitFacet.UnitDataStruct
    ]): string;
    decodeFunctionResult(functionFragment: "initUnit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "startBridgeTokensViaUnit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapAndStartBridgeTokensViaUnit", data: BytesLike): Result;
    events: {
        ...
        "UnitInitialized(bytes,bytes,bytes)": EventFragment;
    };
    ...
    getEvent(nameOrSignatureOrTopic: "UnitInitialized"): EventFragment;
}
...
export interface UnitInitializedEventObject {
    unitNodePublicKey: string;
    h1NodePublicKey: string;
    fieldNodePublicKey: string;
}
export type UnitInitializedEvent = TypedEvent<[
    string,
    string,
    string
], UnitInitializedEventObject>;
export type UnitInitializedEventFilter = TypedEventFilter<UnitInitializedEvent>;
export interface UnitFacet extends BaseContract {
    ...
    functions: {
        initUnit(_unitNodePublicKey: PromiseOrValue<BytesLike>, _h1NodePublicKey: PromiseOrValue<BytesLike>, _fieldNodePublicKey: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        startBridgeTokensViaUnit(_bridgeData: ILiFi.BridgeDataStruct, _unitData: UnitFacet.UnitDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaUnit(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _unitData: UnitFacet.UnitDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    initUnit(_unitNodePublicKey: PromiseOrValue<BytesLike>, _h1NodePublicKey: PromiseOrValue<BytesLike>, _fieldNodePublicKey: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        initUnit(_unitNodePublicKey: PromiseOrValue<BytesLike>, _h1NodePublicKey: PromiseOrValue<BytesLike>, _fieldNodePublicKey: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        startBridgeTokensViaUnit(_bridgeData: ILiFi.BridgeDataStruct, _unitData: UnitFacet.UnitDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaUnit(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _unitData: UnitFacet.UnitDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        "UnitInitialized(bytes,bytes,bytes)"(unitNodePublicKey?: null, h1NodePublicKey?: null, fieldNodePublicKey?: null): UnitInitializedEventFilter;
        UnitInitialized(unitNodePublicKey?: null, h1NodePublicKey?: null, fieldNodePublicKey?: null): UnitInitializedEventFilter;
    };
    estimateGas: {
        initUnit(_unitNodePublicKey: PromiseOrValue<BytesLike>, _h1NodePublicKey: PromiseOrValue<BytesLike>, _fieldNodePublicKey: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
