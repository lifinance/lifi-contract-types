...
export interface ContractInvalidAuditInterface extends utils.Interface {
    functions: {
...
export interface ContractInvalidAudit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ContractInvalidAuditInterface;
