...
export declare namespace CentrifugeFacet {
    ...
    type CentrifugeDataStructOutput = [string] & {
        receiver: string;
    };
}
...
export interface CentrifugeFacetInterface extends utils.Interface {
    functions: {
        "startBridgeTokensViaCentrifuge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaCentrifuge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "startBridgeTokensViaCentrifuge" | "swapAndStartBridgeTokensViaCentrifuge"): FunctionFragment;
