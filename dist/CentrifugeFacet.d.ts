...
export declare namespace CentrifugeFacet {
    type CentrifugeDataStruct = {
        nativeFee: PromiseOrValue<BigNumberish>;
        refundRecipient: PromiseOrValue<string>;
    };
    type CentrifugeDataStructOutput = [BigNumber, string] & {
        nativeFee: BigNumber;
...
export interface CentrifugeFacetInterface extends utils.Interface {
    functions: {
        "TOKEN_BRIDGE()": FunctionFragment;
        "startBridgeTokensViaCentrifuge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint256,address))": FunctionFragment;
        "swapAndStartBridgeTokensViaCentrifuge((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint256,address))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "TOKEN_BRIDGE" | "startBridgeTokensViaCentrifuge" | "swapAndStartBridgeTokensViaCentrifuge"): FunctionFragment;
    encodeFunctionData(functionFragment: "TOKEN_BRIDGE", values?: undefined): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaCentrifuge", values: [ILiFi.BridgeDataStruct, CentrifugeFacet.CentrifugeDataStruct]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaCentrifuge", values: [
        ILiFi.BridgeDataStruct,
        LibSwap.SwapDataStruct[],
        CentrifugeFacet.CentrifugeDataStruct
    ]): string;
    decodeFunctionResult(functionFragment: "TOKEN_BRIDGE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "startBridgeTokensViaCentrifuge", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapAndStartBridgeTokensViaCentrifuge", data: BytesLike): Result;
    events: {
...
export interface CentrifugeFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CentrifugeFacetInterface;
    ...
    functions: {
        ...
        startBridgeTokensViaCentrifuge(_bridgeData: ILiFi.BridgeDataStruct, _centrifugeData: CentrifugeFacet.CentrifugeDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaCentrifuge(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _centrifugeData: CentrifugeFacet.CentrifugeDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    TOKEN_BRIDGE(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        TOKEN_BRIDGE(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaCentrifuge(_bridgeData: ILiFi.BridgeDataStruct, _centrifugeData: CentrifugeFacet.CentrifugeDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaCentrifuge(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _centrifugeData: CentrifugeFacet.CentrifugeDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
