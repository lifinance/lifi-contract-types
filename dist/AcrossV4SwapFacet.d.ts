...
export declare namespace AcrossV4SwapFacet {
    type AcrossV4SwapFacetDataStruct = {
        swapApiTarget: PromiseOrValue<BigNumberish>;
        callData: PromiseOrValue<BytesLike>;
    };
    type AcrossV4SwapFacetDataStructOutput = [number, string] & {
...
export interface AcrossV4SwapFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaAcrossV4Swap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint8,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaAcrossV4Swap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint8,bytes))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "ACROSS_CHAIN_ID_SOLANA" | "MULTIPLIER_BASE" | "SPOKE_POOL" | "SPOKE_POOL_PERIPHERY" | "SPONSORED_CCTP_SRC_PERIPHERY" | "SPONSORED_OFT_SRC_PERIPHERY" | "startBridgeTokensViaAcrossV4Swap" | "swapAndStartBridgeTokensViaAcrossV4Swap"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "SPOKE_POOL_PERIPHERY", values?: undefined): string;
    encodeFunctionData(functionFragment: "SPONSORED_CCTP_SRC_PERIPHERY", values?: undefined): string;
    encodeFunctionData(functionFragment: "SPONSORED_OFT_SRC_PERIPHERY", values?: undefined): string;
    encodeFunctionData(functionFragment: "startBridgeTokensViaAcrossV4Swap", values: [
        ILiFi.BridgeDataStruct,
        AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct
    ]): string;
    encodeFunctionData(functionFragment: "swapAndStartBridgeTokensViaAcrossV4Swap", values: [
        ILiFi.BridgeDataStruct,
    ...
    decodeFunctionResult(functionFragment: "SPOKE_POOL_PERIPHERY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "SPONSORED_CCTP_SRC_PERIPHERY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "SPONSORED_OFT_SRC_PERIPHERY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "startBridgeTokensViaAcrossV4Swap", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "swapAndStartBridgeTokensViaAcrossV4Swap", data: BytesLike): Result;
    events: {
...
export interface AcrossV4SwapFacet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _acrossV4SwapFacetData: AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _acrossV4SwapFacetData: AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    ACROSS_CHAIN_ID_SOLANA(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        SPONSORED_CCTP_SRC_PERIPHERY(overrides?: CallOverrides): Promise<string>;
        SPONSORED_OFT_SRC_PERIPHERY(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _acrossV4SwapFacetData: AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _acrossV4SwapFacetData: AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    populateTransaction: {
        ...
        SPOKE_POOL_PERIPHERY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        SPONSORED_CCTP_SRC_PERIPHERY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        SPONSORED_OFT_SRC_PERIPHERY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        startBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _acrossV4SwapFacetData: AcrossV4SwapFacet.AcrossV4SwapFacetDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
