...
export declare namespace AcrossV4SwapFacet {
    ...
    type AcrossV4SwapFacetDataStructOutput = [number, string, string] & {
...
export interface AcrossV4SwapFacetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ACROSS_CHAIN_ID_SOLANA" | "MULTIPLIER_BASE" | "SPOKE_POOL" | "SPOKE_POOL_PERIPHERY" | "SPONSORED_CCTP_SRC_PERIPHERY" | "SPONSORED_OFT_SRC_PERIPHERY" | "WRAPPED_NATIVE" | "startBridgeTokensViaAcrossV4Swap" | "swapAndStartBridgeTokensViaAcrossV4Swap"): FunctionFragment;
