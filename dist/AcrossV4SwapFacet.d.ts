...
export declare namespace AcrossV4SwapFacet {
    ...
    type AcrossV4SwapDataStructOutput = [
...
export interface AcrossV4SwapFacetInterface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaAcrossV4Swap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),((address,bytes32,uint256,address,bytes32,uint256,bytes32,uint32,uint32,uint32,bytes),address,address,uint8,bytes,uint256,uint128,bool))": FunctionFragment;
        "swapAndStartBridgeTokensViaAcrossV4Swap((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],((address,bytes32,uint256,address,bytes32,uint256,bytes32,uint32,uint32,uint32,bytes),address,address,uint8,bytes,uint256,uint128,bool))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "ACROSS_CHAIN_ID_SOLANA" | "MULTIPLIER_BASE" | "SPOKE_POOL" | "SPOKE_POOL_PERIPHERY" | "startBridgeTokensViaAcrossV4Swap" | "swapAndStartBridgeTokensViaAcrossV4Swap"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "startBridgeTokensViaAcrossV4Swap", values: [ILiFi.BridgeDataStruct, AcrossV4SwapFacet.AcrossV4SwapDataStruct]): string;
...
export interface AcrossV4SwapFacet extends BaseContract {
    ...
    functions: {
        ...
        startBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _acrossV4SwapData: AcrossV4SwapFacet.AcrossV4SwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapAndStartBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _acrossV4SwapData: AcrossV4SwapFacet.AcrossV4SwapDataStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    ACROSS_CHAIN_ID_SOLANA(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        SPOKE_POOL(overrides?: CallOverrides): Promise<string>;
        SPOKE_POOL_PERIPHERY(overrides?: CallOverrides): Promise<string>;
        startBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _acrossV4SwapData: AcrossV4SwapFacet.AcrossV4SwapDataStruct, overrides?: CallOverrides): Promise<void>;
        swapAndStartBridgeTokensViaAcrossV4Swap(_bridgeData: ILiFi.BridgeDataStruct, _swapData: LibSwap.SwapDataStruct[], _acrossV4SwapData: AcrossV4SwapFacet.AcrossV4SwapDataStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
