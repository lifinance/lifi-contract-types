...
export interface IYieldAdapterInterface extends utils.Interface {
    functions: {
        ...
        "maxDepositableValue(address,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "deposit" | "maxDepositableValue" | "maxWithdrawableValue" | "resolveAsset" | "totalAssets" | "withdraw"): FunctionFragment;
    encodeFunctionData(functionFragment: "deposit", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "maxDepositableValue", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "maxDepositableValue", data: BytesLike): Result;
...
export interface IYieldAdapter extends BaseContract {
    ...
    functions: {
        ...
        maxDepositableValue(_underlying: PromiseOrValue<string>, _holder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            assets: BigNumber;
        }>;
    ...
    populateTransaction: {
        ...
        maxDepositableValue(_underlying: PromiseOrValue<string>, _holder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
