...
export interface CelerIMFacetTestInterface extends utils.Interface {
    functions: {
...
export interface CelerIMFacetTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CelerIMFacetTestInterface;
