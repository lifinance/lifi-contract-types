...
export interface AcrossFacetV4Interface extends utils.Interface {
    functions: {
        ...
        "startBridgeTokensViaAcrossV4((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(bytes32,bytes32,bytes32,uint256,uint128,bytes32,uint32,uint32,uint32,bytes))": FunctionFragment;
        "swapAndStartBridgeTokensViaAcrossV4((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(bytes32,bytes32,bytes32,uint256,uint128,bytes32,uint32,uint32,uint32,bytes))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "ACROSS_CHAIN_ID_SOLANA" | "SPOKE_POOL" | "WRAPPED_NATIVE" | "startBridgeTokensViaAcrossV4" | "swapAndStartBridgeTokensViaAcrossV4"): FunctionFragment;
