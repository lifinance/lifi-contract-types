...
export declare namespace GardenFacet {
    ...
    type GardenDataStructOutput = [string, string, BigNumber, string] & {
        redeemer: string;
...
export interface GardenFacetInterface extends utils.Interface {
    functions: {
        "startBridgeTokensViaGarden((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,uint256,bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaGarden((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(address,address,uint256,bytes32))": FunctionFragment;
    };
