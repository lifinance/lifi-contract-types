...
export declare namespace GardenFacet {
    type InitConfigStruct = {
        ...
        htlcAddress: PromiseOrValue<string>;
        assetType: PromiseOrValue<BigNumberish>;
    };
    type InitConfigStructOutput = [string, string, number] & {
        assetAddress: string;
        htlcAddress: string;
        assetType: number;
    };
    ...
    type GardenDataStructOutput = [BigNumber, string] & {
        timelock: BigNumber;
        secretHash: string;
    };
}
...
export interface GardenFacetInterface extends utils.Interface {
    functions: {
        "initGarden((address,address,uint8)[])": FunctionFragment;
        "startBridgeTokensViaGarden((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(uint256,bytes32))": FunctionFragment;
        "swapAndStartBridgeTokensViaGarden((bytes32,string,string,address,address,address,uint256,uint256,bool,bool),(address,address,address,address,uint256,bytes,bool)[],(uint256,bytes32))": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "initGarden" | "startBridgeTokensViaGarden" | "swapAndStartBridgeTokensViaGarden"): FunctionFragment;
    encodeFunctionData(functionFragment: "initGarden", values: [GardenFacet.InitConfigStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "initGarden", data: BytesLike): Result;
    ...
    events: {
        ...
        "GardenInitialized()": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "GardenInitialized"): EventFragment;
...
export interface GardenInitializedEventObject {
}
export type GardenInitializedEvent = TypedEvent<[
], GardenInitializedEventObject>;
export type GardenInitializedEventFilter = TypedEventFilter<GardenInitializedEvent>;
...
export interface GardenFacet extends BaseContract {
    ...
    functions: {
        initGarden(configs: GardenFacet.InitConfigStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        initGarden(configs: GardenFacet.InitConfigStruct[], overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "GardenInitialized()"(): GardenInitializedEventFilter;
        GardenInitialized(): GardenInitializedEventFilter;
